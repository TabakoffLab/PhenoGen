...
<div id="page" style="min-height:1050px;text-align:center;">
    ...
    <div style="border-color:#CCCCCC; border-width:1px; border-style:inset; text-align:center;">
        ...
        <div id="collapsableImage" class="geneimage" >
            ...
            <script src="javascript/GenomeDataBrowser2.1.17.js" type="text/javascript"></script>
            <script src="javascript/GenomeReport2.1.3.js" type="text/javascript"></script>
            <script src="javascript/GenomeViewMenu2.0.8.js" type="text/javascript"></script>
