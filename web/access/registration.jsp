...
<% if (thisUser_id == -99) { %>
	...
	<BR>
			...
			<tr>
				...
				<td> <input type="text" name="first_name" size="15"> &nbsp; 
				</td>
			</tr><tr>
				<td>&nbsp;</td> 
				<td align="right"> MI</td>
				<td><input type="text" name="middle_name"  size="3">&nbsp; </td>
			</tr><tr>
				<td>&nbsp;</td> 
			...
			<tr>
				...
				<td><input type="text" name="telephone"  size="15"> </td>
			</tr>
			<tr>
				<td>&nbsp;</td> 
			...
			<tr>
				...
				<td><input type="text" name="lab_name"  size="30"></td>
			</tr>
			<tr>
				<td>&nbsp;</td> 
				<td align="right"> Box </td>
				<td><input type="text" name="box"  size="5"> </td>
			</tr>
			...
			<tr>
				...
				<td> 
				 <INPUT type=radio name="selfPIRadio" id="selfPIRadio1" checked><span id="selectedPI" style="text-transform:capitalize">Self</span>
		...
		<p id="contactArea">
			...
			<input id="pi_user_id" name="pi_user_id" type="hidden" value="-99"/>
	     ...
	     <div id="backgroundPopup"></div>
			...
			<tr>
				...
				<td><input type="text" name="street"  size="65"> </td>
			</tr>
			...
			<tr>
				...
				<td><input type="text" name="country" value="USA" size="10"> </td>		
			</tr>
