			...
			<div id="topAccord<%=level%>" style="height:100%; text-align:left;">
                ...
                <div>
                	<!--<div id="genomeSub<%=level%>" style="width:100%;">-->
                    	<div class="trigger triggerEC" name="Annotation" style="width:342px;background-color:#CCCCCC;border:solid; border-color:#000000; border-width:1px 1px 0px 1px;">Annotations</div>
                        <div id="Annotation" style="width:372px;display:none;border:solid; border-color:#000000; border-width:0px 1px 1px 1px;">
                        ...
                        <BR />
                    	<div class="trigger triggerEC" name="Variation" style="width:342px;background-color:#CCCCCC;border:solid; border-color:#000000; border-width:1px 1px 0px 1px;">Strain Variation</div>
                        <div id="Variation" style="width:372px;display:none;border:solid; border-color:#000000; border-width:0px 1px 1px 1px;">
                        ...
                        <BR />
                        <div class="trigger triggerEC" name="QTL" style="width:342px;background-color:#CCCCCC;border:solid; border-color:#000000; border-width:1px 1px 0px 1px;">QTLs</div>
                        <div id="QTL" style="width:372px;display:none;border:solid; border-color:#000000; border-width:0px 1px 1px 1px;">
            ...
            <span class="Imagetooltip" title="This track will display the publicly available bQTLs from Rat Genome Database. Any bQTLs that overlap the region are represented by a solid black bar.  More details on each bQTL are available under the bQTL Tab."><img src="<%=imagesDir%>icons/info.gif"></span>
                ...
                <div>
                	<!--<div id="trxomeSub<%=level%>">-->
                    	<div class="trigger triggerEC" name="AffySection" style="width:342px;background-color:#CCCCCC;border:solid; border-color:#000000; border-width:1px 1px 0px 1px;">Affymetrix Exon 1.0ST Data</div>
                        <div id="AffySection" style="width:372px;display:none; border:solid; border-color:#000000; border-width:0px 1px 1px 1px;">
                        ...
                        <%if(myOrganism.equals("Rn")){%>
                            <div class="trigger triggerEC" name="RNACount" style="width:342px;background-color:#CCCCCC;border:solid; border-color:#000000; border-width:1px 1px 0px 1px;">Brain Tissue RNA-Seq Count Data</div>
                            <div id="RNACount" style="width:372px;display:none;border:solid; border-color:#000000; border-width:0px 1px 1px 1px;">
                           ...
                           <BR />
                           <div class="trigger triggerEC" name="RNATrx" style="width:342px;background-color:#CCCCCC;border:solid; border-color:#000000; border-width:1px 1px 0px 1px;">Brain Tissue RNA-Seq Transcript Reconstruction</div>
                           <div id="RNATrx" style="width:372px;display:none;border:solid; border-color:#000000; border-width:1px 1px 1px 1px;">
