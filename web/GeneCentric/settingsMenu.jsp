...
<style>
    ...
    <div class="settingsLevel<%=level%>"  style="display:none;width:400px;border:solid;border-color:#000000;border-width:1px; z-index:999; position:absolute; top:50px; left:-98px; background-color:#FFFFFF; min-height:450px; text-align:center;">
          ...
          <div style="color:#000000; text-align:left;">Image Tracks:</div>
			<div id="topAccord<%=level%>" style="height:100%; text-align:left;">
                ...
                <div>
                        ...
                        <div id="Sequence<%=level%>" style="width:372px;display:none;border:solid; border-color:#000000; border-width:0px 1px 1px 1px;">
                            ...
                            <span class="tracktooltip<%=level%>"  id="genomeSeqInfoDesc" title="This track displays the reference genomic sequence of the selected organism. It is automatically displayed when viewing <=300bp.  You can uncheck to disable displaying the track when viewing <300bp."><img src="<%=imagesDir%>icons/info.gif"></span>
                	...
                	<!--<div id="genomeSub<%=level%>" style="width:100%;">-->
                        ...
                        <div id="Annotation<%=level%>" style="width:372px;display:none;border:solid; border-color:#000000; border-width:0px 1px 1px 1px;">
                            ...
                            <span class="tracktooltip<%=level%>" id="trxInfoDesc" title="This track consists of transcripts from the selected feature.  See the legend for the color coding."><img src="<%=imagesDir%>icons/info.gif"></span>
             				<HR />
                    		<%}%>
                            ...
                            <span class="tracktooltip<%=level%>" id="codingInfoDesc" title="This track consists of transcripts from Ensembl(Brown,Ensembl ID) and PhenoGen RNA-Seq reconstructed transcripts(from CuffLinks) (Light Blue, Tissue.#).  Tracks are labeled with either an Ensembl ID or a PhenoGen ID that also indicates the tissue sequenced.  See the legend for the color coding."><img src="<%=imagesDir%>icons/info.gif"></span>
                            ...
                            <span class="tracktooltip<%=level%>" id="noncodingInfoDesc" title="This track consists of Long Non-Coding RNAs(>=200bp) from Ensembl(Purple,Ensembl ID) and PhenoGen RNA-Seq(Green,Tissue.#).  For Ensembl Transcripts this includes any biotype other than protein coding.  For PhenoGen RNA-Seq it includes any transcript detected in the Non-PolyA+ fraction."><img src="<%=imagesDir%>icons/info.gif"></span>
                            ...
                            <span class="tracktooltip<%=level%>" id="smallncInfoDesc" title="This track consists of small RNAs(<200bp) from Ensembl(Yellow,Ensembl ID) and PhenoGen RNA-Seq(Green,smRNA.#)."><img src="<%=imagesDir%>icons/info.gif"></span>
                            ...
                            <span class="tracktooltip<%=level%>" id="refSeqInfoDesc" title="This track consists of Ref Seq Transcripts that were grouped into genes to match the Ensembl Tracks."><img src="<%=imagesDir%>icons/info.gif"></span>
                        ...
                        <div id="Variation<%=level%>" style="width:372px;display:none;border:solid; border-color:#000000; border-width:0px 1px 1px 1px;">
                            ...
                            <select name="trackSelect" id="snpSHRH<%=level%>Select">
                             ...
                             <HR />
                             <input name="trackcbx" type="checkbox" id="snpBNLXCBX<%=level%>"  />BN-Lx/CubPrin <span class="tracktooltip<%=level%>" id="snpBNLXInfoDesc" title="SNPs/Indels from the DNA sequencing of the BN-Lx and the SHR inbred rat strain genome.  BN-Lx and SHR are the parental strains of the HXB/BXH recombinant inbred panel used in the microarray studies displayed on this page.  SNPs/indels are in relation to the reference BN genome (rn5).  When labels are visible for the SNP/Indel features the labels are the reference sequence:strain sequence.<BR><BR> For example:<BR>T:A is a SNP where T was changed to an A in the strain specific sequence.<BR>TA:TAA - is an insertion of an A in the reference Sequence TA.<BR>TAA:TA is the deletion of an A from the reference sequence TAA.<BR><BR>Capitalization:<BR>Bases are reported in lower case if they are part of an algorithmically determined repeat region and are not altered from the reference. Reference bases that are altered (SNPs and deletions) are reported in uppercase in the reference sequence and the strain-specific sequence."><img src="<%=imagesDir%>icons/info.gif"></span>
                            ...
                            <HR />
                            <input name="trackcbx" type="checkbox" id="snpF344CBX<%=level%>"  />F344 <span class="tracktooltip<%=level%>" id="snpF344InfoDesc" title="SNPs/Indels from the DNA sequencing of the BN-Lx and the SHR inbred rat strain genome.  BN-Lx and SHR are the parental strains of the HXB/BXH recombinant inbred panel used in the microarray studies displayed on this page.  SNPs/indels are in relation to the reference BN genome (rn5).  When labels are visible for the SNP/Indel features the labels are the reference sequence:strain sequence.<BR><BR> For example:<BR>T:A is a SNP where T was changed to an A in the strain specific sequence.<BR>TA:TAA - is an insertion of an A in the reference Sequence TA.<BR>TAA:TA is the deletion of an A from the reference sequence TAA.<BR><BR>Capitalization:<BR>Bases are reported in lower case if they are part of an algorithmically determined repeat region and are not altered from the reference. Reference bases that are altered (SNPs and deletions) are reported in uppercase in the reference sequence and the strain-specific sequence."><img src="<%=imagesDir%>icons/info.gif"></span>
                            ...
                            <HR />
                            <input name="trackcbx" type="checkbox" id="snpSHRJCBX<%=level%>" />SHR/NCrlPrin <span class="tracktooltip<%=level%>" id="snpSHRJInfoDesc" title="SNPs/Indels from the DNA sequencing of the BN-Lx and the SHR inbred rat strain genome.  BN-Lx and SHR are the parental strains of the HXB/BXH recombinant inbred panel used in the microarray studies displayed on this page.  SNPs/indels are in relation to the reference BN genome (rn5).  When labels are visible for the SNP/Indel features the labels are the reference sequence:strain sequence.<BR><BR> For example:<BR>T:A is a SNP where T was changed to an A in the strain specific sequence.<BR>TA:TAA - is an insertion of an A in the reference Sequence TA.<BR>TAA:TA is the deletion of an A from the reference sequence TAA.<BR><BR>Capitalization:<BR>Bases are reported in lower case if they are part of an algorithmically determined repeat region and are not altered from the reference. Reference bases that are altered (SNPs and deletions) are reported in uppercase in the reference sequence and the strain-specific sequence."><img src="<%=imagesDir%>icons/info.gif"></span>
            ...
            <span class="tracktooltip<%=level%>" id="qtlInfoDesc" title="This track will display the publicly available bQTLs from Rat Genome Database. Any bQTLs that overlap the region are represented by a solid black bar.  More details on each bQTL are available under the bQTL Tab."><img src="<%=imagesDir%>icons/info.gif"></span>
                        </div>
                    <!--</div>-->
                </div>
                ...
                <div>
                	<!--<div id="trxomeSub<%=level%>">-->
                        ...
                        Affymetrix Exon Array Probe Sets <span class="tracktooltip<%=level%>" id="probeInfoDesc" title="All the non-masked Affymetrix Exon 1.0 ST probesets."><img src="<%=imagesDir%>icons/info.gif"></span>
                        ...
                        <%if(myOrganism.equals("Rn")){%>
                           ...
                           <div id="RNATrx<%=level%>" style="width:372px;display:none;border:solid; border-color:#000000; border-width:1px 1px 1px 1px;">
                            ...
                            <span class="tracktooltip<%=level%>" id="codingtInfoDesc" title="This track consists of transcripts from Ensembl(Brown,Ensembl ID) and PhenoGen RNA-Seq reconstructed transcripts(from CuffLinks) (Light Blue, Tissue.#).  Tracks are labeled with either an Ensembl ID or a PhenoGen ID that also indicates the tissue sequenced.  See the legend for the color coding."><img src="<%=imagesDir%>icons/info.gif"></span>
                            ...
                            <span class="tracktooltip<%=level%>" id="noncodingtInfoDesc" title="This track consists of Long Non-Coding RNAs(>=200bp) from Ensembl(Purple,Ensembl ID) and PhenoGen RNA-Seq(Green,Tissue.#).  For Ensembl Transcripts this includes any biotype other than protein coding.  For PhenoGen RNA-Seq it includes any transcript detected in the Non-PolyA+ fraction."><img src="<%=imagesDir%>icons/info.gif"></span>
                            ...
                            <span class="tracktooltip<%=level%>" id="smallnctInfoDesc" title="This track consists of small RNAs(<200bp) from Ensembl(Yellow,Ensembl ID) and PhenoGen RNA-Seq(Green,smRNA.#)."><img src="<%=imagesDir%>icons/info.gif"></span>
