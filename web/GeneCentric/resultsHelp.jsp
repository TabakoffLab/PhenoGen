...
<BR />
To see additional detail click on a feature.  Features that are clickable will have a pointer(<span style="cursor:pointer;">Hold your mouse over this to see what the pointer will look like</span>) when you hold the mouse over them.   
<BR />
<BR />
To Zoom in/out move the mouse over the scale at the top(<span style="cursor:ew-resize; color:;">See what the pointer will look like</span>) of the image and drag right to zoom in and left to zoom out.  Or you can double click on a feature to zoom in on it specifically.
<BR /><BR />
