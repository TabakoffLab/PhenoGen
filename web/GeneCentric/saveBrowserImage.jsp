...
<%
	...
	String htmlEnd="</div><script>d3.select(\"#singleWGCNASVG\").attr(\"width\",\"1000\").attr(\"height\",\"1000\");d3.select(\"#circosModule\").attr(\"width\",\"3000\").attr(\"height\",\"3000\").style(\"height\",\"\").style(\"width\",\"\");d3.select(\"#viewport\").attr(\"transform\",\"scale(0.90)\");d3.selectAll(\".infoIcon\").remove();d3.selectAll(\".settings\").remove();d3.selectAll(\".scroll\").style(\"overflow\",\"\").style(\"max-height\",\"\");</script></BODY></HTML>";
