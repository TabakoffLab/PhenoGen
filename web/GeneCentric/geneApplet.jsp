...
<div style="border-color:#CCCCCC; border-width:1px; border-style:inset; text-align:center;">
        ...
        <div id="collapsableImage" class="geneimage" >
            ...
            <script src="<%=contextRoot%>javascript/GenomeDataBrowser0.6.3.js" type="text/javascript"></script>
            <script src="<%=contextRoot%>javascript/GenomeReport0.2.js" type="text/javascript"></script>
