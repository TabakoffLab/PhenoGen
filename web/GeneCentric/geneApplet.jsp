...
<div style="border-color:#CCCCCC; border-width:1px; border-style:inset; text-align:center;">
        ...
        <div id="collapsableImage" class="geneimage" >
            ...
            <script src="<%=contextRoot%>javascript/GenomeDataBrowser2.1.16.js" type="text/javascript"></script>
            <script src="<%=contextRoot%>javascript/GenomeReport2.1.2.js" type="text/javascript"></script>
            <script src="<%=contextRoot%>javascript/GenomeViewMenu2.0.7.js" type="text/javascript"></script>
