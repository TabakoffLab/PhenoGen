...
<div style="border-color:#CCCCCC; border-width:1px; border-style:inset; text-align:center;">
        ...
        <div id="collapsableImage" class="geneimage" >
            ...
            <script src="<%=contextRoot%>javascript/GenomeDataBrowser2.1.15.js" type="text/javascript"></script>
            <script src="<%=contextRoot%>javascript/GenomeReport2.1.1.js" type="text/javascript"></script>
            <script src="<%=contextRoot%>javascript/GenomeViewMenu2.0.6.js" type="text/javascript"></script>
