...
<%if(missingPhenoGenIDError){%>
  <div style="color:#FF0000;">RNA-Seq based eQTLs are not available for this Ensembl gene as none of the reconstruction transcripts matched a transcript in this gene.  </div>
