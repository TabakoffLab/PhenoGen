...
<%@ include file="/web/common/header.jsp" %>
		...
		<p><a href="<%=helpDir%>Annotation_Overview.htm">iDecoder</a>: &nbsp;&nbsp;Last updated on May 21st, 2013 with annotation data from the following sources:</p>
		</p>
		<ul>
			...
			<li>Location data from Ensembl for Mouse, Human, and Rat from Ensembl Genes 71 
			<li>FlyBase gene_map_table_fb_2013_01.tsv file and fbgn_NAseq_Uniprot_fb_2013_01.tsv 
			<li>MGI database links file generated from the ACC_Accession table on 5/21/2013
			<li>MGI_Coordinate.rpt links file, downloaded 5/21/2013 
			<li>NCBI gene2accession file, downloaded 5/21/2013
			<li>NCBI gene2unigene file, downloaded 5/21/2013
			<li>NCBI gene_info file, downloaded 5/21/2013
			<li>NCBI homologene.data file, 5/21/2013 
			<li>RGD GENES file, last updated on 5/21/2013
			<li>SwissProt uniprot_sprot.dat file, last updated on 5/21/2013
		</ul>
	</div>
    </div>
