...
<BR />
                ...
                <div class="demoVideo" style="display:inline-block;float:right;position:relative;top:-600px; padding-right:10px;">
                        	...
                        	<video id="demoVid1" width="375"  controls="controls" poster="<%=contextRoot%>web/demo/BrowserNavDemo.png">
                        	...
                        	<video id="demoVid1" width="375"  controls="controls" poster="<%=contextRoot%>web/demo/customTrackDemo.png">
                        	...
                        	<video id="demoVid" width="375"  controls="controls" poster="<%=contextRoot%>web/demo/detailed_transcript_fullv3.png">
