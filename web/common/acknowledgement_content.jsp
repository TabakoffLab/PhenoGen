 ...
 *  Created: Sept, 2017
 *  Description:  Content for Acknowledgements to be used on multiple pages.
 *
 *  Todo: 
 *  Modification Log:
 *      
...
<h3 style="margin:10px;">Recombinant Inbred Panels</h3>
    ...
    <p>F344/LE Rat RI Panel was provided by <a href="http://www.med.kyoto-u.ac.jp/en/organization-staff/research/doctoral_course/r-022/">Masahide Asano</a>(National BioResource Project for the Rat in Japan).</p>
