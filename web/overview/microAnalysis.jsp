	...
	<H2>Normalize->Statistics->Gene List</H2>
                    <div id="accordion" style="height:100%;">
                        ...
                        <div style="text-align:center">
                            ...
                            The last step is saving the probes to a gene list which will allow you to perform the other gene list analyses on the probes(genes) found in your analysis.
                            <a class="fancybox" rel="fancybox-thumb" href="web/overview/microAnalysis_save.jpg" title="The last step is saving the probes to a gene list which will allow you to perform the other gene list analyses on the probes(genes) found in your analysis."><img src="web/overview/microAnalysis_save.jpg"  style="width:100%;" title="Click to view a larger image"/></a>
                        </div>
