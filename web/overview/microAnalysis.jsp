	...
	<H2>Normalize->Statistics->Gene List</H2>
                   <div  style="overflow:auto;height:92%;">
                        ...
                        <div style="overflow:auto;display:inline-block;height:27%;width:100%;">
                        	...
                        	<a class="fancybox" rel="fancybox-thumb" href="web/overview/microAnalysis_list.jpg" title="List of datasets available.  Start analysis of existing datasets by clicking on the dataset or you can create a new dataset from this page."><img src="web/overview/microAnalysis_list.jpg"  style="width:150px;" /></a></span>
                            </TD>
                            <TD>
                            ...
                            <a class="fancybox" rel="fancybox-thumb" href="web/overview/microAnalysis_stats.jpg" title="Next you can perform statistics.  Based on the analysis type and number of groups you will be given the most relevant choices of statistical methods."><img src="web/overview/microAnalysis_stats.jpg"  style="width:150px;" /></a></span>
                            </TD>
                            <TD>
                            ...
                            <a class="fancybox" rel="fancybox-thumb" href="web/overview/microAnalysis_save.jpg" title="The last step is saving the probes to a gene list which will allow you to perform the other gene list analyses on the probes(genes) found in your analysis."><img src="web/overview/microAnalysis_save.jpg"  style="width:150px;" /></a></span>
                            </TD>
                            </TR>
                            </table>
                            </div>
