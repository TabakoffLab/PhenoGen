...
<% 
	...
	if (((action != null) && action.equals("Get Transcription Details"))||auto) {
					...
					if(homologList.size()>0){
							...
							for (int i=0; i< homologList.size(); i++) {
								...
								if(homologIdentifier.getIdentifier().indexOf("T0")!=6){
									...
									String tmpURL =(String)session.getAttribute("genURL");
									String tmpGeneSymbol=(String)session.getAttribute("geneSymbol");
									String tmpUcscURL =(String)session.getAttribute("ucscURL");
									String tmpUcscURLFiltered =(String)session.getAttribute("ucscURLFiltered");
...
<form method="post" 
		...
		name="geneCentric">
    	<label>Gene:
  		<input type="text" name="geneTxt" id="geneTxt" value="<%= (myGene!=null)?myGene:"" %>">
  		</label>
  <label>Species:
