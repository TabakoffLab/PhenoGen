...
statistics.Clustering.HDF5 <- function(InputFile,VersionPath, SampleFile, ClusterType, ClusterObject, RunGroups = FALSE, GroupLabels, Distance, parameter1, parameter2=-99, error.file){
