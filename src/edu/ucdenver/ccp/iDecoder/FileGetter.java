...
/*
	...
	files.add(new String[] {affyExonMain, mainDir + "Affymetrix/", "RaEx-1_0-st-v1.na31.rn4.probeset.csv.zip"});
*/
	files.add(new String[] {flybaseMain, mainDir + "FlyBase/", "fbgn_NAseq_Uniprot_fb_2014_01.tsv.gz"});
	files.add(new String[] {flybaseMain, mainDir + "FlyBase/", "gene_map_table_fb_2014_01.tsv.gz"}); 
