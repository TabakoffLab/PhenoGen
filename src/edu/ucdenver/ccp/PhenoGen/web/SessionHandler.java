...
public class SessionHandler {
	...
	public void setUCSCDbPropertiesFile(String inString) {
        ...
        public String getMongoDbPropertiesFile() {
		return this.getPropertiesDir() + "/" + mongoDbPropertiesFile; 
	}

	public void setMongoDbPropertiesFile(String inString) {
		this.mongoDbPropertiesFile = inString;
	}  
...
*/
	...
	public void setSessionVariables(HttpSession session, User userLoggedIn) {
		...
		//
                ...
                session.setAttribute("mongoDbPropertiesFile", this.getMongoDbPropertiesFile());
