...
package OPOSSUM::Analysis::FisherResult;
...
=head2 new
 ...
 Title    : new
 Usage    : $fr = OPOSSUM::Analysis::FisherResult->new(
					-id		=> $id,
					-t_hits		=> $t_hits,
					-t_no_hits	=> $t_no_hits,
					-bg_hits	=> $bg_hits,
					...
					-p_value	=> $p_value);
 Function : Create a new OPOSSUM::Analysis::FisherResult object.
...
=head2 t_hits
 ...
 Function : Get/set the number of genes for which this TFBS was detected
...
=head2 t_no_hits
 ...
 Function : Get/set the number of genes for which this TFBS was not
