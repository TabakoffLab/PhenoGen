...
end positions of the TFBS site on the promoter pair sequences as well as the
PSSM score and level of conservation.
...
=head2 tf_id
 ...
 Title   : tf_id
 Usage   : $tf_id = $ctfs->tf_id() or $ctfs->tf_id($id);
