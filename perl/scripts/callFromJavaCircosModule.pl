...
require 'callCircosModule.pl';
	...
	my $arg8 = $ARGV[7]; # module color
        my $arg9 = $ARGV[8]; # genome Version
	my $arg10= $ARGV[9]; # dsn
	my $arg11= $ARGV[10]; # user
	my $arg12= $ARGV[11]; # password
	callCircosMod($arg1, $arg2, $arg3, $arg4, $arg5, $arg6, $arg7, $arg8, $arg9, $arg10,$arg11,$arg12);
