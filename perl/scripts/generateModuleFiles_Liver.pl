...
#            print OFILE "\n\t\t\t\t],\n";#end Transcript List
    ...
    my $eqtlAOHRef = readLocusSpecificPvaluesModule($mod,$org,"Liver",\@chrArr,$genomeVer,$dsn,$user,$passwd);
    ...
    callCircosMod($mod,$cutoff,$org,$chrString,"Liver",$tmpPath,"1",$modRGB,$genomeVer,$dsn,$user, $passwd);
}