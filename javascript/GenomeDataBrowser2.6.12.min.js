...
a),d3.select("#Level"+d.levelNumber+a).attr("height",15),d.addTrackErrorRemove(d3.select("#Level"+d.levelNumber+a),"#Level"+d.levelNumber+a);else if(null==k)if(11<=n){g=[];var q=GeneTrack(d,g,a,"Long Non-Coding / Non-PolyA+ Genes",f);d.addTrackList(q)}else setTimeout(function(){d.addTrack(a,c,f,10)},5E3);else{g=k.documentElement.getElementsByTagName("Gene");var m=0,e=k.documentElement.getElementsByTagName("GeneList");0<e.length&&"undefined"!==typeof e[0].getAttribute("ver")&&(m=e[0].getAttribute("ver"));
try{q=GeneTrack(d,g,a,"Long Non-Coding / Non-PolyA+ Genes",f),q.dataVer=m,d.addTrackList(q)}catch(F){}}});else if(-1<a.indexOf("coding"))d3.xml(dataPrefix+"tmpData/browserCache/"+genomeVer+"/regionData/"+d.folderName+"/"+a+".xml",function(b,k){if(b)if(10>n){var g=2500;1==n&&(g=1E4);setTimeout(function(){d.addTrack(a,c,f,n+1)},g)}else d3.select("#Level"+d.levelNumber+a).select("#trkLbl").text("An errror occurred loading Track:"+a),d3.select("#Level"+d.levelNumber+a).attr("height",15),d.addTrackErrorRemove(d3.select("#Level"+
d.levelNumber+a),"#Level"+d.levelNumber+a);else if(null==k)if(11<=n){g=[];var q=GeneTrack(d,g,a,"Protein Coding / PolyA+",f);d.addTrackList(q)}else setTimeout(function(){d.addTrack(a,c,f,11)},5E3);else{g=k.documentElement.getElementsByTagName("Gene");var m=0,e=k.documentElement.getElementsByTagName("GeneList");0<e.length&&"undefined"!==typeof e[0].getAttribute("ver")&&(m=e[0].getAttribute("ver"));try{q=GeneTrack(d,g,a,"Protein Coding / PolyA+",f),q.dataVer=m,d.addTrackList(q)}catch(F){console.log(F)}}});
else if(-1<a.indexOf("smallnc"))d3.xml(dataPrefix+"tmpData/browserCache/"+genomeVer+"/regionData/"+d.folderName+"/"+a+".xml",function(b,k){if(b){if(0===n){var g=d.xScale.domain()[0],q=d.xScale.domain()[1],m=contextPath+"/"+pathPrefix;pathPrefix||(m="");$.ajax({url:m+"generateTrackXML.jsp",type:"GET",cache:!1,data:{chromosome:chr,minCoord:g,maxCoord:q,panel:panel,rnaDatasetID:rnaDatasetID,arrayTypeID:arrayTypeID,myOrganism:organism,genomeVer:genomeVer,track:a,folder:d.folderName},dataType:"json",success:function(a){ga&&
ga("send","event","browser","generateTrackRefseq")},error:function(a,d,c){}})}10>n?(g=2500,1==n&&(g=1E4),setTimeout(function(){d.addTrack(a,c,f,n+1)},g)):(d3.select("#Level"+d.levelNumber+a).select("#trkLbl").text("An errror occurred loading Track:"+a),d3.select("#Level"+d.levelNumber+a).attr("height",15),d.addTrackErrorRemove(d3.select("#Level"+d.levelNumber+a),"#Level"+d.levelNumber+a))}else if(null==k)11<=n?(g=[],q=GeneTrack(d,g,a,"Small RNA (<200 bp) Genes",f),d.addTrackList(q)):setTimeout(function(){d.addTrack(a,
c,f,11)},5E3);else{g="rn5"===genomeVer?k.documentElement.getElementsByTagName("smnc"):k.documentElement.getElementsByTagName("Gene");try{q=GeneTrack(d,g,a,"Small RNA (<200 bp) Genes",f),d.addTrackList(q),""!=selectGene&&q.setSelected(selectGene)}catch(G){}}});else if("liverTotal"===a||"heartTotal"===a||"brainTotal"===a||"mergedTotal"===a){var m="Liver Reconstructed";"heartTotal"===a?m="Heart Reconstructed":"brainTotal"===a?m="Whole Brain Reconstructed":"mergedTotal"===a&&(m="Merged (Brain,Heart,Liver) Reconstructed");
d3.xml(dataPrefix+"tmpData/browserCache/"+genomeVer+"/regionData/"+d.folderName+"/"+a+".xml",function(b,k){if(b){if(1===n&&"mergedTotal"===a){var g=d.xScale.domain()[0],q=d.xScale.domain()[1],e=contextPath+"/"+pathPrefix;pathPrefix||(e="");$.ajax({url:e+"generateTrackXML.jsp",type:"GET",cache:!1,data:{chromosome:chr,minCoord:g,maxCoord:q,panel:panel,rnaDatasetID:rnaDatasetID,arrayTypeID:arrayTypeID,myOrganism:organism,genomeVer:genomeVer,track:a,folder:d.folderName},dataType:"json",success:function(a){ga&&
ga("send","event","browser","generateTrackRefseq")},error:function(a,d,c){}})}10>n?(g=2500,1==n&&(g=1E4),setTimeout(function(){d.addTrack(a,c,f,n+1)},g)):(d3.select("#Level"+d.levelNumber+a).select("#trkLbl").text("An errror occurred loading Track:"+a),d3.select("#Level"+d.levelNumber+a).attr("height",15),d.addTrackErrorRemove(d3.select("#Level"+d.levelNumber+a),"#Level"+d.levelNumber+a))}else if(null==k)11<=n?(g=[],q=GeneTrack(d,g,a,m,f),d.addTrackList(q)):setTimeout(function(){d.addTrack(a,c,f,
11)},5E3);else{g=k.documentElement.getElementsByTagName("Gene");e=0;var r=k.documentElement.getElementsByTagName("GeneList");0<r.length&&"undefined"!==typeof r[0].getAttribute("ver")&&(e=r[0].getAttribute("ver"));try{q=GeneTrack(d,g,a,m,f),q.dataVer=e,d.addTrackList(q),""!=selectGene&&q.setSelected(selectGene)}catch(F){}}})}else if(0===a.indexOf("refSeq")){$("#"+a+d.levelNumber+"Select").val();var q=d.xScale.domain()[0],e=d.xScale.domain()[1];k=dataPrefix+"tmpData/browserCache/"+genomeVer+"/regionData/"+
d.folderName+"/"+a+".xml";d3.xml(k,function(b,k){if(b){console.log(b);if(0===n){var g=contextPath+"/"+pathPrefix;pathPrefix||(g="");$.ajax({url:g+"generateTrackXML.jsp",type:"GET",cache:!1,data:{chromosome:chr,minCoord:q,maxCoord:e,panel:panel,rnaDatasetID:rnaDatasetID,arrayTypeID:arrayTypeID,myOrganism:organism,genomeVer:genomeVer,track:a,folder:d.folderName},dataType:"json",success:function(a){ga&&ga("send","event","browser","generateTrackRefseq")},error:function(a,d,c){}})}10>n?(g=2500,1===n&&
(g=1E4),setTimeout(function(){d.addTrack(a,c,f,n+1)},g)):(d3.select("#Level"+d.levelNumber+a).select("#trkLbl").text("An errror occurred loading Track:"+a),d3.select("#Level"+d.levelNumber+a).attr("height",15),d.addTrackErrorRemove(d3.select("#Level"+d.levelNumber+a),"#Level"+d.levelNumber+a))}else if(null==k)if(11<=n){g=[];var m=RefSeqTrack(d,g,a,"Ref Seq Genes",f);d.addTrackList(m)}else setTimeout(function(){d.addTrack(a,c,f,11)},5E3);else{g=k.documentElement.getElementsByTagName("Gene");try{m=
RefSeqTrack(d,g,a,"Ref Seq Genes",f),d.addTrackList(m)}catch(w){console.log(w)}}})}else if(0==a.indexOf("snp"))q=d.xScale.domain()[0],e=d.xScale.domain()[1],k=dataPrefix+"tmpData/browserCache/"+genomeVer+"/regionData/"+d.folderName+"/"+a+".xml",d3.xml(k,function(b,k){if(b){console.log(b);if(0==n){var g=contextPath+"/"+pathPrefix;pathPrefix||(g="");$.ajax({url:g+"generateTrackXML.jsp",type:"GET",cache:!1,data:{chromosome:chr,minCoord:q,maxCoord:e,panel:panel,rnaDatasetID:rnaDatasetID,arrayTypeID:arrayTypeID,
myOrganism:organism,genomeVer:genomeVer,track:a,folder:d.folderName},dataType:"json",success:function(a){ga&&ga("send","event","browser","generateTrackSNP")},error:function(a,d,c){}})}10>n?(g=2500,1==n&&(g=15E3),setTimeout(function(){d.addTrack(a,c,f,n+1)},g)):(d3.select("#Level"+d.levelNumber+a).select("#trkLbl").text("An errror occurred loading Track:"+a),d3.select("#Level"+d.levelNumber+a).attr("height",15),d.addTrackErrorRemove(d3.select("#Level"+d.levelNumber+a),"#Level"+d.levelNumber+a))}else if(null==
k)if(11<=n){g=[];var m=SNPTrack(d,g,a,c,f);d.addTrackList(m)}else setTimeout(function(){d.addTrack(a,c,f,11)},5E3);else{g=k.documentElement.getElementsByTagName("Snp");try{m=SNPTrack(d,g,a,c,f),d.addTrackList(m)}catch(w){}}});else if("qtl"==a)d3.xml(dataPrefix+"tmpData/browserCache/"+genomeVer+"/regionData/"+d.folderName+"/qtl.xml",function(b,k){if(b)if(10>n){var g=2500;1==n&&(g=1E4);setTimeout(function(){d.addTrack(a,c,f,n+1)},g)}else d3.select("#Level"+d.levelNumber+a).select("#trkLbl").text("An errror occurred loading Track:"+
a),d3.select("#Level"+d.levelNumber+a).attr("height",15),d.addTrackErrorRemove(d3.select("#Level"+d.levelNumber+a),"#Level"+d.levelNumber+a);else if(null==k)if(11<=n){g=[];var q=QTLTrack(d,g,a,c);d.addTrackList(q)}else setTimeout(function(){d.addTrack(a,c,f,11)},5E3);else{g=k.documentElement.getElementsByTagName("QTL");try{q=QTLTrack(d,g,a,c),d.addTrackList(q)}catch(w){}}});else if("trx"==a)k=getAllChildrenByName(getFirstChildByName(d.selectedData,"TranscriptList"),"Transcript"),k=TranscriptTrack(d,
k,a,c),d.addTrackList(k);else if("probe"==a||"probeMouse"==a)d3.xml(dataPrefix+"tmpData/browserCache/"+genomeVer+"/regionData/"+d.folderName+"/probe.xml",function(b,k){if(b)if(10>n){var g=2500;1==n&&(g=1E4);setTimeout(function(){d.addTrack(a,c,f,n+1)},g)}else d3.select("#Level"+d.levelNumber+a).select("#trkLbl").text("An errror occurred loading Track:"+a),d3.select("#Level"+d.levelNumber+a).attr("height",15),d.addTrackErrorRemove(d3.select("#Level"+d.levelNumber+a),"#Level"+d.levelNumber+a);else if(null==
k)11<=n?(q=[],g=ProbeTrack(d,q,a,"Affy Exon 1.0 ST Probe Sets",c+","+f),d.addTrackList(g)):setTimeout(function(){d.addTrack(a,c,f,11)},5E3);else{var q=k.documentElement.getElementsByTagName("probe");try{g=ProbeTrack(d,q,a,"Affy Exon 1.0 ST Probe Sets",c+","+f),d.addTrackList(g)}catch(w){}}});else if("helicos"==a||-1<a.indexOf("illuminaTotal")||-1<a.indexOf("illuminaSmall")||"illuminaPolyA"==a){q=d.xScale.domain()[0];e=d.xScale.domain()[1];var h=calculateBin(e-q,d.width);k=dataPrefix+"tmpData/browserCache/"+
genomeVer+"/regionData/"+d.folderName+"/tmp/"+q+"_"+e+".count."+a+".xml";0<h&&(q-=q%h,e+=h-e%h,k=dataPrefix+"tmpData/browserCache/"+genomeVer+"/regionData/"+d.folderName+"/tmp/"+q+"_"+e+".bincount."+h+"."+a+".xml");d3.xml(k,function(b,k){if(b){if(0==n||3==n){var g=contextPath+"/"+pathPrefix;pathPrefix||(g="");tmpPanel=panel;-1<a.indexOf("-")&&(tmpPanel=a.substr(a.indexOf("-")+1));$.ajax({url:g+"generateTrackXML.jsp",type:"GET",cache:!1,data:{chromosome:chr,minCoord:q,maxCoord:e,panel:tmpPanel,rnaDatasetID:rnaDatasetID,
arrayTypeID:arrayTypeID,myOrganism:organism,genomeVer:genomeVer,track:a,folder:d.folderName,binSize:h},dataType:"json",success:function(a){ga&&ga("send","event","browser","generateTrackCounts")},error:function(a,d,b){}});g=1E4}30>n?(g=1E4,0===n&&(g=5E3),setTimeout(function(){d.addTrack(a,c,f,n+1)},g)):(d3.select("#Level"+d.levelNumber+a).select("#trkLbl").text("An errror occurred loading Track:"+a),d3.select("#Level"+d.levelNumber+a).attr("height",15),d.addTrackErrorRemove(d3.select("#Level"+d.levelNumber+
a),"#Level"+d.levelNumber+a))}else if(null==k)4<=n?(g=[],"helicos"==a?m=HelicosTrack(d,g,a,1):"illuminaTotal"==a?m=IlluminaTotalTrack(d,g,a,1):"illuminaSmall"==a?m=IlluminaSmallTrack(d,g,a,1):"illuminaPolyA"==a?m=IlluminaPolyATrack(d,g,a,1):"liverilluminaTotalPlus"==a?m=LiverIlluminaTotalPlusTrack(d,g,a,1):"liverilluminaTotalMinus"==a?m=LiverIlluminaTotalMinusTrack(d,g,a,1):"heartilluminaTotalPlus"==a?m=HeartIlluminaTotalPlusTrack(d,g,a,1):"heartilluminaTotalMinus"==a?m=HeartIlluminaTotalMinusTrack(d,
g,a,1):"brainilluminaTotalPlus"==a?m=BrainIlluminaTotalPlusTrack(d,g,a,1):"brainilluminaTotalMinus"==a?m=BrainIlluminaTotalMinusTrack(d,g,a,1):"liverilluminaSmall"==a?m=LiverIlluminaSmallTrack(d,g,a,1):"heartilluminaSmall"==a?m=HeartIlluminaSmallTrack(d,g,a,1):-1<a.indexOf("illuminaTotal")&&(m=StrainSpecificIlluminaTotalTrack(d,g,a,1)),d.addTrackList(m)):setTimeout(function(){d.addTrack(a,c,f,4)},3E3);else{g=k.documentElement.getElementsByTagName("Count");var m;try{"helicos"===a?m=HelicosTrack(d,
g,a,1):"illuminaTotal"===a?m=IlluminaTotalTrack(d,g,a,1):"illuminaSmall"===a?m=IlluminaSmallTrack(d,g,a,1):"illuminaPolyA"===a?m=IlluminaPolyATrack(d,g,a,1):"liverilluminaTotalPlus"===a?m=LiverIlluminaTotalPlusTrack(d,g,a,1):"liverilluminaTotalMinus"===a?m=LiverIlluminaTotalMinusTrack(d,g,a,1):"heartilluminaTotalPlus"===a?m=HeartIlluminaTotalPlusTrack(d,g,a,1):"heartilluminaTotalMinus"===a?m=HeartIlluminaTotalMinusTrack(d,g,a,1):"brainilluminaTotalPlus"===a?m=BrainIlluminaTotalPlusTrack(d,g,a,1):
"brainilluminaTotalMinus"===a?m=BrainIlluminaTotalMinusTrack(d,g,a,1):"liverilluminaSmall"===a?m=LiverIlluminaSmallTrack(d,g,a,1):"heartilluminaSmall"===a?m=HeartIlluminaSmallTrack(d,g,a,1):-1<a.indexOf("illuminaTotal")&&(m=StrainSpecificIlluminaTotalTrack(d,g,a,1)),d.addTrackList(m)}catch(w){}}})}else if(-1<a.indexOf("spliceJnct")){q=d.xScale.domain()[0];e=d.xScale.domain()[1];k=dataPrefix+"tmpData/browserCache/"+genomeVer+"/regionData/"+d.folderName+"/"+a+".xml";var l="Brain ";"liverspliceJnct"==
a?l="Liver ":"heartspliceJnct"==a&&(l="Heart ");d3.xml(k,function(b,g){if(b){console.log(b);if(0==n){var k=contextPath+"/"+pathPrefix;pathPrefix||(k="");$.ajax({url:k+"generateTrackXML.jsp",type:"GET",cache:!1,data:{chromosome:chr,minCoord:q,maxCoord:e,panel:panel,rnaDatasetID:rnaDatasetID,arrayTypeID:arrayTypeID,myOrganism:organism,genomeVer:genomeVer,track:a,folder:d.folderName},dataType:"json",success:function(a){ga&&ga("send","event","browser","generateTrackSpliceJnct")},error:function(a,d,b){}})}10>
n?(k=2500,1==n&&(k=1E4),setTimeout(function(){d.addTrack(a,c,f,n+1)},k)):(d3.select("#Level"+d.levelNumber+a).select("#trkLbl").text("An errror occurred loading Track:"+a),d3.select("#Level"+d.levelNumber+a).attr("height",15),d.addTrackErrorRemove(d3.select("#Level"+d.levelNumber+a),"#Level"+d.levelNumber+a))}else if(null==g)if(11<=n){k=[];var m=SpliceJunctionTrack(d,k,a,l+"Splice Junctions",1,"");d.addTrackList(m)}else setTimeout(function(){d.addTrack(a,c,f,11)},5E3);else{k=g.documentElement.getElementsByTagName("Feature");
console.log(k);try{m=SpliceJunctionTrack(d,k,a,l+"Splice Junctions",3,""),d.addTrackList(m)}catch(w){console.log(w)}}})}else if("polyASite"==a)d3.xml(dataPrefix+"tmpData/browserCache/"+genomeVer+"/regionData/"+d.folderName+"/polyASite.xml",function(b,g){if(b)if(3>n){var k=1E4;1==n&&(k=15E3);setTimeout(function(){d.addTrack(a,c,f,n+1)},k)}else d3.select("#Level"+d.levelNumber+a).select("#trkLbl").text("An errror occurred loading Track:"+a),d3.select("#Level"+d.levelNumber+a).attr("height",15),d.addTrackErrorRemove(d3.select("#Level"+
d.levelNumber+a),"#Level"+d.levelNumber+a);else if(null==g)if(4<=n){k=[];var m=PolyATrack(d,k,a,"Predicted PolyA Sites",f);d.addTrackList(m)}else setTimeout(function(){d.addTrack(a,c,f,4)},5E3);else{k=g.documentElement.getElementsByTagName("Feature");try{m=PolyATrack(d,k,a,"Predicted PolyA Sites",f),d.addTrackList(m)}catch(w){}}});else if(0===a.indexOf("repeatMask"))$("#"+a+d.levelNumber+"Select").val(),q=d.xScale.domain()[0],e=d.xScale.domain()[1],k=dataPrefix+"tmpData/browserCache/"+genomeVer+"/regionData/"+
d.folderName+"/"+a+".xml",d3.xml(k,function(b,k){if(b){console.log(b);if(0===n){var g=contextPath+"/"+pathPrefix;pathPrefix||(g="");$.ajax({url:g+"generateTrackXML.jsp",type:"GET",cache:!1,data:{chromosome:chr,minCoord:q,maxCoord:e,panel:panel,rnaDatasetID:rnaDatasetID,arrayTypeID:arrayTypeID,myOrganism:organism,genomeVer:genomeVer,track:a,folder:d.folderName},dataType:"json",success:function(a){ga&&ga("send","event","browser","generateTrackRepeatMask")},error:function(a,d,b){}})}10>n?(g=2500,1===
n&&(g=1E4),setTimeout(function(){d.addTrack(a,c,f,n+1)},g)):(d3.select("#Level"+d.levelNumber+a).select("#trkLbl").text("An errror occurred loading Track:"+a),d3.select("#Level"+d.levelNumber+a).attr("height",15),d.addTrackErrorRemove(d3.select("#Level"+d.levelNumber+a),"#Level"+d.levelNumber+a))}else if(null==k)if(11<=n){g=[];var m=RepeatMaskTrack(d,g,a,"Repeat Masker",c,f);d.addTrackList(m)}else setTimeout(function(){d.addTrack(a,c,f,11)},5E3);else{g=k.documentElement.getElementsByTagName("Feature");
try{m=RepeatMaskTrack(d,g,a,"Repeat Masker",c,f),d.addTrackList(m)}catch(w){console.log(w)}}});else if(0==a.indexOf("custom"))if(k=trackInfo[a],f=f+",Name="+k.Name,f="DataFile="+k.Location+","+f,"bed"==k.Type||"bb"==k.Type)g=[],k=CustomTranscriptTrack(d,g,a,k.Name,3,f),d.addTrackList(k),k.updateFullData(0,0);else if("bg"==k.Type||"bw"==k.Type)g=[],k=CustomCountTrack(d,g,a,3,f),d.addTrackList(k);$(".sortable"+d.levelNumber).sortable("refresh");ga&&ga("send","event","trackAdded",a)};d.addTrackList=
function(a){null!=a&&(d.trackList[d.trackCount]=a,d.trackCount++,d.trackListHash[a.trackClass]=a,setTimeout(function(){DisplayRegionReport()},300))};d.updateLinks=function(){1===d.levelNumber&&d3.select("#probeSetDetailLink1").each(function(){var a=new String(d3.select(this).attr("href"));a=a.substr(0,a.lastIndexOf("=")+1);a+=d.currentView.ViewID;d3.select(this).attr("href",a)})};d.changeTrackHeight=function(a,d){0<d?d3.select("#"+a+"Scroll").style("max-height",d+"px").style("overflow","auto"):d3.select("#"+
a+"Scroll").style("max-height","none").style("overflow","hidden")};d.removeAllTracks=function(){d3.selectAll("li.draggable"+d.levelNumber).remove();d.trackList=[];setTimeout(function(){DisplayRegionReport()},300);ga&&ga("send","event","SVGremoveAllTracks",d.levelNumber)};d.removeTrack=function(a){d3.select("#Level"+d.levelNumber+a).remove();for(var b=0;b<d.trackList.length;b++)"undefined"!==typeof d.trackList[b]&&d.trackList[b].trackClass==a&&(d.trackList.splice(b,1),d.trackCount--);d.trackListHash[a]=
void 0;setTimeout(function(){DisplayRegionReport()},300);ga&&ga("send","event","removeTrack",d.levelNumber,a)};d.redrawTrack=function(a){for(var b=0;b<d.trackList.length;b++)"undefined"!==typeof d.trackList[b]&&d.trackList[b].trackClass==a&&d.trackList[b].redraw();setTimeout(function(){DisplayRegionReport()},300)};d.redraw=function(){for(var a=0;a<d.trackList.length;a++)"undefined"!==typeof d.trackList[a]&&"undefined"!==typeof d.trackList[a].redraw&&d.trackList[a].redraw();d.selectSvg.redraw()};d.update=
function(){for(var a=0;a<d.trackList.length;a++)"undefined"!==typeof d.trackList[a].update&&d.trackList[a].update();setTimeout(function(){DisplayRegionReport()},300);ga&&ga("send","event","gsvgUpdate","genomeSVG.update")};d.updateData=function(){for(var a=0;a<d.trackList.length;a++)"undefined"!==typeof d.trackList[a]&&"undefined"!==typeof d.trackList[a].updateData&&d.trackList[a].updateData(0);d.updateFullData();setTimeout(function(){DisplayRegionReport()},300);ga&&ga("send","event","gsvgUpdateData",
"genomeSVG.updateData")};d.updateFullData=function(){-1<(new String(d.folderName)).indexOf("img")&&$.ajax({url:pathPrefix+"getFullPath.jsp",type:"GET",async:!1,data:{chromosome:chr,minCoord:d.xScale.domain()[0],maxCoord:d.xScale.domain()[1],panel:panel,rnaDatasetID:rnaDatasetID,arrayTypeID:arrayTypeID,myOrganism:organism,genomeVer:genomeVer},dataType:"json",success:function(a){d.folderName=a.folderName;0==d.levelNumber&&regionfolderName!=d.folderName&&(regionfolderName=d.folderName);setTimeout(function(){DisplayRegionReport()},
300)},error:function(a,d,b){console.log(b)}});for(var a=0;a<d.trackList.length;a++)"undefined"!==typeof d.trackList[a]&&"undefined"!==typeof d.trackList[a].updateFullData&&d.trackList[a].updateFullData(0,1);ga&&ga("send","event","gsvgUpdateFullData","genomeSVG.updateFullData")};d.setLoading=function(){for(var a=0;a<d.trackList.length;a++)"undefined"===typeof d.trackList[a]||"undefined"===typeof d.trackList[a].updateData&&"undefined"===typeof d.trackList[a].updateFullData||d.trackList[a].showLoading()};
d.clearSelection=function(){d.selectionStart=-1;d.selectionEnd=-1;d.scaleSVG.selectAll("rect.selectedArea").remove();d.selectSvg.setVis(!1);for(var a=0;a<d.trackList.length;a++)"undefined"!==typeof d.trackList[a]&&"undefined"!==typeof d.trackList[a].clearSelection&&d.trackList[a].clearSelection()};d.mdown=function(){if(0==d.overSettings)if("dragzoom"!==d.defaultMouseFunct&&d3.event.altKey||"dragzoom"===d.defaultMouseFunct&&!d3.event.altKey){var a=d3.mouse(d.vis.node());d.downZoomx=a[0];d.scaleSVG.append("rect").attr("class",
"zoomRect").attr("x",a[0]).attr("y",0).attr("height",d.scaleSVG.attr("height")).attr("width",1).attr("fill","#CECECE").attr("opacity",.3);d.scaleSVG.append("text").attr("id","zoomTextStart").attr("x",d.downZoomx).attr("y",15).text(numberWithCommas(Math.round(d.xScale.invert(d.downZoomx))));d.scaleSVG.append("text").attr("id","zoomTextEnd").attr("x",d.downZoomx).attr("y",50).text(numberWithCommas(Math.round(d.xScale.invert(d.downZoomx))))}else 0==processAjax&&(d.prevMinCoord=d.xScale.domain()[0],d.prevMaxCoord=
d.xScale.domain()[1],a=d3.mouse(d.vis.node()),d.downx=d.xScale.invert(a[0]),d.downscalex=d.xScale)};d.forceDrawAs=function(a){for(var b=0;b<d.trackList.length;b++)"undefined"!==typeof d.trackList[b]&&"undefined"!==typeof d.trackList[b].drawAs&&(d.trackList[b].drawAs=a,d.trackList[b].draw(d.trackList[b].data));d.forceDrawAsValue=a};d.resize=function(a){d.width=a;d.xScale.range([0,d.width]);d.xAxis=d3.axisTop(d.xScale).ticks(6).tickSize(8).tickPadding(10);d.scaleSVG.attr("width",d.width);d.scaleSVG.select(".x.axis").call(d.xAxis);
d3.select("#Level"+d.levelNumber).select(".axisLbl").attr("x",(d.width-2*d.margin)/2);d.topLevel.style("width",d.width+18+"px");for(var b=0;b<d.trackList.length;b++)"undefined"!==typeof d.trackList[b]&&"undefined"!==typeof d.trackList[b].redraw&&d.trackList[b].resize();d.selectSvg.width=a;d.selectSvg.draw()};d.updateCountScales=function(a,b){for(var c=0;c<d.trackList.length;c++)"undefined"!==typeof d.trackList[c]&&"undefined"!==typeof d.trackList[c].updateCountScale&&d.trackList[c].updateCountScale(a,
b)};d.resetDefaultMouse=function(a){var b="/web/images/icons/"+a+"_dark.png";d3.select("span#"+a+d.levelNumber+" img").attr("src",b);d3.select("span#"+a+d.levelNumber).style("background","#DCDCDC")};d.changeTrackCursor=function(a){for(var b=0;b<d.trackList.length;b++)"undefined"!==typeof d.trackList[b]&&"undefined"!==typeof d.trackList[b].svg&&d.trackList[b].svg.style("cursor",a)};d.changeScaleCursor=function(a){"undefined"!==typeof d.scaleSVG&&d.scaleSVG.style("cursor",a)};d.updateTrackSelectedArea=
function(a,b){d.selectionStart=a;d.selectionEnd=b;var c=d.xScale(a),f=d.xScale(b)-c;d.scaleSVG.selectAll("rect.selectedArea").remove();if((0<c||0<c+f)&&c<d.width)for(1>f&&(f=1),d.scaleSVG.append("rect").attr("class","selectedArea").attr("x",c).attr("y",15).attr("height",d.scaleSVG.attr("height")-15).attr("width",f).attr("fill","#CECECE").attr("opacity",.3).attr("pointer-events","none"),c=0;c<d.trackList.length;c++)"undefined"!==typeof d.trackList[c]&&"undefined"!==typeof d.trackList[c].setSelectedArea&&
d.trackList[c].setSelectedArea(a,b)};d.getAddMenus=function(){var a=contextPath+"/"+pathPrefix;""==pathPrefix&&(a="");$.ajax({url:a+"trackMenu.jsp",type:"GET",cache:!1,data:{level:d.levelNumber,organism:organism},dataType:"html",success:function(a){$("#trackMenu"+d.levelNumber).remove();d3.select("div#trackMenu").append("div").attr("id","trackMenu"+d.levelNumber);$("#trackMenu"+d.levelNumber).html(a)},error:function(a,b,c){$("#trackMenu"+d.levelNumber).remove();d3.select("div#trackMenu").append("div").attr("id",
"trackMenu"+d.levelNumber);$("#trackMenu"+d.levelNumber).append('<div class="viewsLevel'+d.levelNumber+'">An error occurred generating this menu.  Please try back later.</div>')},async:!1});$.ajax({url:a+"viewMenu.jsp",type:"GET",cache:!1,data:{level:d.levelNumber,organism:organism},dataType:"html",success:function(a){$("#viewMenu"+d.levelNumber).remove();d3.select("div#viewMenu").append("div").attr("id","viewMenu"+d.levelNumber);$("#viewMenu"+d.levelNumber).html(a)},error:function(a,b,c){$("#viewMenu"+
d.levelNumber).remove();d3.select("div#viewMenu").append("div").attr("id","viewMenu"+d.levelNumber);$("#viewMenu"+d.levelNumber).append('<div class="viewsLevel'+d.levelNumber+'">An error occurred generating this menu.  Please try back later.</div>')},async:!1})};d.zoomMenuChange=function(a){d3.select("#zoomSelectMenu"+d.levelNumber).selectAll("li").style("background","#FFFFFF");d.zoomFactor=parseFloat(d3.select(a).attr("value"));d3.select(a).style("background","#CECECE")};d.setupFunctionBar=function(){d3.select(e).select("#functLevel"+
d.levelNumber).remove();d.functionBar=d.vis.append("div").attr("class","functionBar").attr("id","functLevel"+d.levelNumber).style("float","left");var a=d.functionBar.append("div").attr("class","defaultMouse").attr("id","defaultMouse"+d.levelNumber);a.append("span").attr("id","dragzoom"+d.levelNumber).style("height","24px").style("display","inline-block").style("cursor","pointer").append("img").attr("class","mouseOpt dragzoom").attr("src","/web/images/icons/dragzoom_dark.png").attr("pointer-events",
"all").on("click",function(){d.resetDefaultMouse(d.defaultMouseFunct);d.defaultMouseFunct="dragzoom";d3.select(this).attr("src","/web/images/icons/dragzoom_white.png");d3.select("span#dragzoom"+d.levelNumber).style("background","#989898");d.changeTrackCursor("crosshair");d.changeScaleCursor("crosshair");ga&&ga("send","event","clickDragZoom","")}).on("mouseout",function(){"dragzoom"!=d.defaultMouseFunct&&(d3.select(this).attr("src","/web/images/icons/dragzoom_dark.png"),d3.select("span#dragzoom"+d.levelNumber).style("background",
"#DCDCDC"))}).on("mouseover",function(){d3.select(this).attr("src","/web/images/icons/dragzoom_white.png");d3.select("span#dragzoom"+d.levelNumber).style("background","#989898");$("#mouseHelp").html("Click to set default mouse function to allow click and drag to select a region to zoom in on.")});a.append("span").attr("id","pan"+d.levelNumber).style("height","24px").style("display","inline-block").style("cursor","pointer").append("img").attr("class","mouseOpt pan").attr("src","/web/images/icons/pan_dark.png").attr("pointer-events",
"all").on("click",function(){d.resetDefaultMouse(d.defaultMouseFunct);d.defaultMouseFunct="pan";d3.select(this).attr("src","/web/images/icons/pan_white.png");d3.select("span#pan"+d.levelNumber).style("background","#989898");d.changeTrackCursor("move");d.changeScaleCursor("ew-resize");ga&&ga("send","event","clickPan","")}).on("mouseout",function(){"pan"!=d.defaultMouseFunct&&(d3.select(this).attr("src","/web/images/icons/pan_dark.png"),d3.select("span#pan"+d.levelNumber).style("background","#DCDCDC"))}).on("mouseover",
function(){d3.select(this).attr("src","/web/images/icons/pan_white.png");d3.select("span#pan"+d.levelNumber).style("background","#989898");$("#mouseHelp").html("Click to set default mouse function to allow click and drag to navigate along the genome.")});a.append("span").attr("id","reorder"+d.levelNumber).style("height","24px").style("display","inline-block").style("cursor","pointer").append("img").attr("class","mouseOpt pan").attr("src","/web/images/icons/reorder_dark.png").attr("pointer-events",
"all").on("click",function(){d.resetDefaultMouse(d.defaultMouseFunct);d.defaultMouseFunct="reorder";d3.select(this).attr("src","/web/images/icons/reorder_white.png");d3.select("span#reorder"+d.levelNumber).style("background","#989898");d.changeTrackCursor("ns-resize");d.changeScaleCursor("ew-resize");ga&&ga("send","event","clickReorder","")}).on("mouseout",function(){"reorder"!=d.defaultMouseFunct&&(d3.select(this).attr("src","/web/images/icons/reorder_dark.png"),d3.select("span#reorder"+d.levelNumber).style("background",
"#DCDCDC"))}).on("mouseover",function(){d3.select(this).attr("src","/web/images/icons/reorder_white.png");d3.select("span#reorder"+d.levelNumber).style("background","#989898");$("#mouseHelp").html("Click to set default mouse function to reorder image tracks. <strong>Optionally hold down shift in any mode.</strong>")});$("span#"+d.defaultMouseFunct+d.levelNumber+" img").click();d.functionBar.append("span").attr("class","saveImage control").style("display","inline-block").attr("id","saveLevel"+d.levelNumber).style("cursor",
"pointer").append("img").attr("src","/web/images/icons/savePic_dark.png").attr("pointer-events","all").attr("cursor","pointer").on("click",function(){var a=$(this).parent().attr("id"),d=(new String(a)).substr(9);a=$("div#Level"+d).html();$.ajax({url:pathPrefix+"saveBrowserImage.jsp",type:"POST",contentType:"text/html",data:a+"\n",processData:!1,dataType:"json",success:function(a){var b=new Date;b=b.getMonth()+1+"_"+b.getDate()+"_"+b.getFullYear();var c="http://";"https:"===location.protocol&&(c="https://");
var f=c+urlprefix+"/tmpData/download/"+a.imageFile;a=new String($("#geneTxt").val());a=a.replace(/:/g,"_");a=a.replace(/-/g,"_");a=a.replace(/,/g,"");"Level1"==d&&(a=svgList[1].selectedData.getAttribute("geneSymbol"));var g=a+"_"+b+".png",k=new XMLHttpRequest;k.open("GET",f);k.responseType="blob";k.send();k.onreadystatechange=function(){if(4!=k.readyState||200!=k.status)return!1;var a=document.createElement("a");a.href=window.URL.createObjectURL(k.response);a.download=g;a.style.display="none";document.body.appendChild(a);
try{a.click()}catch(C){$("#mouseHelp").html("<span style='color:#FF0000;'>Your browser will not save the image directly. Image will open in a popup, in the new window right click to save image.</span>"),window.open(f)}return!0};ga&&ga("send","event","browser","saveBrowserImage")},error:function(a,d,b){console.log(b)}});ga&&ga("send","event","saveImage","")}).on("mouseover",function(){d3.select(this).attr("src","/web/images/icons/savePic_white.png");d3.select("span#savePic"+d.levelNumber).style("background",
"#DCDCDC");$("#mouseHelp").html("Click to download a PNG image of the current view.")}).on("mouseout",function(){d3.select(this).attr("src","/web/images/icons/savePic_dark.png");d3.select("span#savePic"+d.levelNumber).style("background","#989898");$("#mouseHelp").html("Navigation Hints: Hold mouse over areas of the image for available actions.")});d.functionBar.append("span").attr("class","reset control").style("display","inline-block").attr("id","resetImage"+d.levelNumber).style("cursor","pointer").append("img").attr("src",
"/web/images/icons/reset_dark.png").attr("pointer-events","all").attr("cursor","pointer").on("click",function(){var a=new String($(this).parent().attr("id"));a=a.substr(a.length-1);0==a?($("#geneTxt").val(chr+":"+initMin+"-"+initMax),svgList[0].xScale.domain([initMin,initMax]),svgList[0].scaleSVG.select(".x.axis").call(svgList[0].xAxis),svgList[0].redraw()):(svgList[a].xScale.domain([svgList[a].initMin,svgList[a].initMax]),svgList[a].scaleSVG.select(".x.axis").call(svgList[a].xAxis),svgList[a].redraw());
svgList[0].updateFullData();ga&&ga("send","event","clickResetImage","")}).on("mouseover",function(){d3.select(this).attr("src","/web/images/icons/reset_white.png");d3.select("span#reset"+d.levelNumber).style("background","#DCDCDC");$("#mouseHelp").html("Click to reset image zoom to initial region.")}).on("mouseout",function(){d3.select(this).attr("src","/web/images/icons/reset_dark.png");d3.select("span#reset"+d.levelNumber).style("background","#989898");$("#mouseHelp").html("Navigation Hints: Hold mouse over areas of the image for available actions.")});
d.functionBar.append("span").attr("class","back control").style("display","inline-block").attr("id","backButton"+d.levelNumber).style("cursor","pointer").append("img").attr("src","/web/images/icons/back_dark2.png").attr("pointer-events","all").attr("cursor","pointer").on("click",function(){back(d.levelNumber);ga&&ga("send","event","clickBack","")}).on("mouseover",function(){d3.select(this).attr("src","/web/images/icons/back_white2.png");$("#mouseHelp").html("Click to undo last zoom/pan.")}).on("mouseout",
function(){d3.select(this).attr("src","/web/images/icons/back_dark2.png");$("#mouseHelp").html("Navigation Hints: Hold mouse over areas of the image for available actions.")});a=d.functionBar.append("span").style("display","inline-block").style("position","relative").style("top","-9px").attr("id","zoom"+d.levelNumber);a.append("button").attr("id","zoomInButton"+d.levelNumber).attr("class","zoomIn").style("height","2.3em").append("img").style("position","relative").style("top","-5px").attr("src","/web/images/icons/magPlus_dark_32.png").attr("pointer-events",
"all").attr("cursor","pointer");a.append("button").attr("id","zoomOutButton"+d.levelNumber).attr("class","zoomOut").style("height","2.3em").append("img").style("position","relative").style("top","-5px").attr("src","/web/images/icons/magMinus_dark_32.png").attr("pointer-events","all").attr("cursor","pointer");a.append("button").attr("id","zoomMenuSelect"+d.levelNumber).attr("class","zoomSelectMenu");testChrome?(console.log("CHROME"),d3.select("#zoomSelect"+d.levelNumber).style("height","2.3em")):testSafari&&
d3.select("#zoomSelect"+d.levelNumber).style("height","2.3em");a=d.functionBar.append("ul").attr("id","zoomSelectMenu"+d.levelNumber);a.append("li").attr("id","zoom1"+d.levelNumber).attr("value","0.025").on("click",function(){d.zoomMenuChange(this)}).text("0.5x");a.append("li").attr("id","zoom2"+d.levelNumber).attr("value","0.05").style("background","#CECECE").on("click",function(){d.zoomMenuChange(this)}).text("1x");a.append("li").attr("id","zoom3"+d.levelNumber).attr("value","0.1").on("click",function(){d.zoomMenuChange(this)}).text("2x");
a.append("li").attr("id","zoom4"+d.levelNumber).attr("value","0.25").on("click",function(){d.zoomMenuChange(this)}).text("5x");a.append("li").attr("id","zoom5"+d.levelNumber).attr("value","0.5").on("click",function(){d.zoomMenuChange(this)}).text("10x");$("#zoomInButton"+d.levelNumber).button().click(function(){zoomIn(d.levelNumber,d.zoomFactor);ga&&ga("send","event","clickZoomIn","")}).on("mouseover",function(){$(this).css("background","#989898");$("img",this).attr("src","/web/images/icons/magPlus_light_32.png");
$("#mouseHelp").html("Click to zoom in on the center of the region.  Click and drag the scale to zoom in or out more quickly or select the region select tool to highlight a specific region.")}).on("mouseout",function(){$(this).css("background","#e6e6e6");$("img",this).attr("src","/web/images/icons/magPlus_dark_32.png");$("#mouseHelp").html("Navigation Hints: Hold mouse over areas of the image for available actions.")}).next().button().click(function(){zoomOut(d.levelNumber,d.zoomFactor);ga&&ga("send",
"event","clickZoomOut","")}).on("mouseover",function(){$(this).css("background","#989898");$("img",this).attr("src","/web/images/icons/magMinus_light_32.png");$("#mouseHelp").html("Click to zoom out from the center of the region.  Click and drag the scale to zoom in or out more quickly or select the region select tool to highlight a specific region.")}).on("mouseout",function(){$(this).css("background","#e6e6e6");$("img",this).attr("src","/web/images/icons/magMinus_dark_32.png");$("#mouseHelp").html("Navigation Hints: Hold mouse over areas of the image for available actions.")}).next().button({text:!1,
icons:{primary:"ui-icon-triangle-1-s"}}).click(function(){var a=$(this).parent().next().show().position({my:"left top",at:"left bottom",of:this});$(document).on("click",function(){a.hide()});return!1}).parent().buttonset().next().hide().menu()};d.generateSettingsString=function(){ret="";$("#ScrollLevel"+d.levelNumber+" li.draggable"+d.levelNumber).each(function(){var a=new String($(this).attr("id"));a=a.substr(2);"undefined"!==typeof d.trackListHash[a]&&(ret+=d.trackListHash[a].generateTrackSettingString())});
return ret};d.setCurrentViewModified=function(){d.currentView.modified=1;$("span#viewModifiedCtl"+d.levelNumber).show()};d.clearCurrentView=function(){d.currentView.modified=0;$("span#viewModifiedCtl"+d.levelNumber).hide()};d.type=c;d.div=e;d.margin=0;d.halfWindowWidth=$(window).width()/2;d.mh=400;d.downx=Math.NaN;d.downscalex;d.downPanx=Math.NaN;d.downZoomx=Math.NaN;d.downZoomxEnd=Math.NaN;d.defaultMouseFunct="pan";d.xMax=29E7;d.xMin=1;d.prevMinCoord=l;d.prevMaxCoord=p;d.initMin=l;d.initMax=p;d.dataMinCoord=
l;d.dataMaxCoord=p;d.y=0;d.xScale=null;d.xAxis=null;d.vis=null;d.level=null;d.svg=null;d.txType=null;d.txList=null;d.tt=null;d.trackList=[];d.trackCount=0;d.levelNumber=b;d.selectedData=null;d.txType=null;d.selectionStart=-1;d.selectionEnd=-1;d.scrollSize=350;d.width=h;d.mw=d.width-d.margin;d3.select(e).select("#viewsLevel"+b).remove();d3.select(e).select("#Level"+b).remove();d.vis=d3.select(e);d.setupFunctionBar();0==$("#viewSelect"+d.levelNumber).length&&(h=d.vis.append("div").style("float","right").style("display",
"inline-block").style("margin-right","5px"),c=h.append("div"),c.append("button").attr("id","viewSelect"+d.levelNumber).attr("class","viewSelect").text("Select/Edit Views").on("mouseout",function(){$("#mouseHelp").html("Navigation Hints: Hold mouse over areas of the image for available actions.")}).on("mouseover",function(){$("#mouseHelp").html("Click to select another view or edit the current view.")}),c.append("button").attr("id","viewMenuSelect"+d.levelNumber).attr("class","viewSelectMenu").on("mouseout",
function(){$("#mouseHelp").html("Navigation Hints: Hold mouse over areas of the image for available actions.")}).on("mouseover",function(){$("#mouseHelp").html("Click for options to quickly save and delete your current view.")}),testChrome?d3.select("#viewSelect"+d.levelNumber).style("height","2.3em"):testSafari?d3.select("#viewSelect"+d.levelNumber).style("height","2.3em"):testFireFox||testIE&&d3.select("#viewSelect"+d.levelNumber).style("position","relative").style("top","-8px").style("height",
"2.3em"),h=h.append("ul").attr("id","viewSelectMenu"+d.levelNumber),h.append("li").attr("id","menusaveView"+d.levelNumber).on("click",function(){viewMenu[d.levelNumber].saveView(d.currentView.ViewID,d,!1);$("#viewModifiedCtl"+d.level).hide();ga&&ga("send","event","menuSaveView","")}).text("Save"),h.append("li").attr("id","menusaveAsView"+d.levelNumber).on("click",function(){viewMenu[d.levelNumber].saveAsView(d.currentView,svgList[d.levelNumber]);$(".viewsLevel"+d.levelNumber).css("top",250).css("left",
$(window).width()-610);$(".viewsLevel"+d.levelNumber).fadeIn("fast");$("#viewModifiedCtl"+d.level).hide();ga&&ga("send","event","menuSaveAsView","")}).text("Save As"),h.append("li").attr("id","menudeleteView"+d.levelNumber).on("click",function(){viewMenu[d.levelNumber].confirmDeleteView(d.currentView);$(".viewsLevel"+d.levelNumber).css("top",250).css("left",$(window).width()-610);$(".viewsLevel"+d.levelNumber).fadeIn("fast");ga&&ga("send","event","menuDeleteView","")}).text("Delete"),$("#viewSelect"+
d.levelNumber).button().click(function(){}).next().button({text:!1,icons:{primary:"ui-icon-triangle-1-s"}}).click(function(){var a=$(this).parent().next().show().position({my:"left top",at:"left bottom",of:this});$(document).on("click",function(){a.hide()});return!1}).parent().buttonset().next().hide().menu(),d.vis.append("span").style("float","right").style("margin-right","5px").append("span").attr("id","mainAddTrack"+d.levelNumber).attr("class","control").style("height","24px").style("display",
"inline-block").style("cursor","pointer").append("img").attr("class","mainAddTrack").attr("src","/web/images/icons/addTrack_dark_32.png").attr("pointer-events","all").style("height","37px").style("position","relative").style("top","-8px").on("click",function(){if($(".trackLevel"+d.levelNumber).is(":visible"))$(".trackLevel"+d.levelNumber).fadeOut("fast");else{var a=$(this).parent().parent().position();trackMenu[d.levelNumber].standalone=!0;$(".trackLevel"+d.levelNumber).css("top",a.top).css("left",
a.left+-561);$(".trackLevel"+d.levelNumber+" span#selectedViewName").html(d.currentView.Name);$(".trackLevel"+d.levelNumber).fadeIn("fast");$("div#selectTrack"+d.levelNumber).show();$("div#addUsrTrack"+d.levelNumber).hide();$("div#addUsrTrack"+d.levelNumber).hide();$("div#deleteUsrTrack"+d.levelNumber).hide();setTimeout(function(){trackMenu[d.levelNumber].generateTrackTable()},250);ga&&ga("send","event","clickAddTrack","")}}).on("mouseout",function(){d3.select(this).attr("src","/web/images/icons/addTrack_dark_32.png");
d3.select("span#mainAddTrack"+d.levelNumber).style("background","#DCDCDC");$("#mouseHelp").html("Navigation Hints: Hold mouse over areas of the image for available actions.")}).on("mouseover",function(){d3.select(this).attr("src","/web/images/icons/addTrack_light_32.png");d3.select("span#mainAddTrack"+d.levelNumber).style("background","#989898");$("#mouseHelp").html("Click to quickly add other tracks to the current view.")}),h=d.vis.append("span").style("float","right").style("margin-right","5px"),
h.append("input").attr("type","checkbox").attr("name","imgCBX").attr("id","forceTrxCBX"+d.levelNumber),h.append("label").attr("for","forceTrxCBX"+d.levelNumber).text("Draw Genes as Transcripts").on("mouseout",function(){$("#mouseHelp").html("Navigation Hints: Hold mouse over areas of the image for available actions.")}).on("mouseover",function(){$("#mouseHelp").html("Click to display Gene Tracks as Transcripts. Note: in smaller regions this occurs automatically.")}),$("input#forceTrxCBX"+d.levelNumber).button(),
h=d.vis.append("span").style("float","right").style("margin-right","5px"),c=h.append("div").attr("class","defaultMouse").style("width","64px").attr("id","scrollSize"+d.levelNumber),c.append("span").attr("id","scrollIncr"+d.levelNumber).style("height","24px").style("display","inline-block").style("cursor","pointer").append("img").attr("class","mouseOpt ").attr("src","/web/images/icons/scroll_smaller.png").attr("pointer-events","all").on("click",function(){d.scrollSize-=100;100>d.scrollSize&&(d.scrollSize=
100);changeTrackHeight("Level"+d.levelNumber,d.scrollSize);ga&&ga("send","event","changeScrollHeight","")}).on("mouseout",function(){$("#mouseHelp").html("Navigation Hints: Hold mouse over areas of the image for available actions.")}).on("mouseover",function(){$("#mouseHelp").html("Decrease the vertical length of the scrollable browser image on the page.")}),c.append("span").attr("id","pan"+d.levelNumber).style("height","24px").style("display","inline-block").style("cursor","pointer").append("img").attr("class",
"mouseOpt pan").attr("src","/web/images/icons/scroll_larger.png").attr("pointer-events","all").on("click",function(){0<$("#ScrollLevel"+d.levelNumber).length&&"undefined"!==typeof $("#ScrollLevel"+d.levelNumber)[0]&&d.scrollSize<$("#ScrollLevel"+d.levelNumber)[0].scrollHeight&&(d.scrollSize+=100,changeTrackHeight("Level"+d.levelNumber,d.scrollSize))}).on("mouseout",function(){$("#mouseHelp").html("Navigation Hints: Hold mouse over areas of the image for available actions.")}).on("mouseover",function(){$("#mouseHelp").html("Increase the vertical length of the scrollable browser image on the page.")}),
h.append("span").attr("class","scrollBtn control").style("display","inline-block").attr("id","scrollImage"+d.levelNumber).style("cursor","pointer").append("img").attr("src","/web/images/icons/scroll.png").attr("pointer-events","all").attr("cursor","pointer").on("click",function(){"/web/images/icons/no_scroll.png"==d3.select(this).attr("src")?(d3.select(this).attr("src","/web/images/icons/scroll.png"),d3.select("span#reset"+d.levelNumber).style("background","#989898"),$("#scrollSize"+d.levelNumber).show(),
changeTrackHeight("Level"+d.levelNumber,d.scrollSize)):(d3.select(this).attr("src","/web/images/icons/no_scroll.png"),d3.select("span#reset"+d.levelNumber).style("background","#DCDCDC"),$("#scrollSize"+d.levelNumber).hide(),changeTrackHeight("Level"+d.levelNumber,0));ga&&ga("send","event","toggleImageScroll","")}).on("mouseover",function(){$("#mouseHelp").html("Click to toggle browser image scrolling on/off.  <b>Off</b> the image takes as much space as needed. <b>On</b> you can adjust the maximum length of the image.")}).on("mouseout",
...
function toolTipSVG(e,h,l,p,b,a,c){var f={isToolTip:1};f.folderName=regionfolderName;f.updateTimeoutHandle={};f.timeoutTrack=-1;f.forLevel=-1;f.strainSpecificCountColors=d3.scaleOrdinal(d3.schemeCategory20);f.get=function(a){return f[a]};f.getTrack=function(a){for(var d,b=0;b<f.trackList.length;b++)"undefined"!==typeof f.trackList[b]&&f.trackList[b].trackClass===a&&(d=f.trackList[b]);return d};f.addTrackErrorRemove=function(a,b){};f.addTrack=function(a,b,c,g){"Trx"==f.forceDrawAsValue&&-1==(new String(c)).indexOf("DrawTrx")&&
(c+="DrawTrx,");var d=d3.select("#Level"+f.levelNumber+a).nodes();if(0===d.length||null==d){d=f.topLevel.append("li").attr("class","draggable"+f.levelNumber).append("svg:svg").attr("width",f.get("width")).attr("height",30).attr("class","track").attr("id","Level"+f.levelNumber+a);var k=new String("Loading...");d.append("text").text(k).attr("x",f.width/2-k.length/2*7.5).attr("y",12).attr("id","trkLbl")}d="";-1<f.forLevel&&99==f.levelNumber&&"undefined"!==typeof svgList[f.forLevel]&&(d=svgList[f.forLevel].getTrack(a).generateTrackSettingString(),
c=d=d.substr(d.indexOf(",")+1));if("genomeSeq"===a){var n=SequenceTrack(f,a,"Reference Genomic Sequence",c);n.seqRegionSize=10;f.addTrackList(n)}else if(-1<a.indexOf("noncoding"))n=GeneTrack(f,g,a,"Non-Coding/Non-PolyA+ Transcripts",c),f.addTrackList(n);else if(-1<a.indexOf("coding"))n=GeneTrack(f,g,a,"Protein Coding/PolyA+ Transcripts",c),f.addTrackList(n);else if("liverTotal"===a||"heartTotal"===a||"brainTotal"===a||"mergedTotal"===a)b="Liver Total RNA Transcripts","heartTotal"===a?b="Heart Total RNA Transcripts":
"brainTotal"===a?b="Brain Total RNA Transcripts":"mergedTotal"===a&&(b="Merged (Brain,Heart,Liver) Reconstructed"),n=GeneTrack(f,g,a,b,c),f.addTrackList(n);else if(-1<a.indexOf("smallnc"))n=GeneTrack(f,g,a,"Small RNA (<200 bp) Genes",c),f.addTrackList(n);else if(0===a.indexOf("refSeq"))99===f.levelNumber&&(c+="DrawTrx,"),n=RefSeqTrack(f,g,a,"Ref Seq Genes",c),n.density=99===f.levelNumber?2:b,f.addTrackList(n);else if(0===a.indexOf("snp"))n=SNPTrack(f,g,a,1,"4"),f.addTrackList(n);else if("qtl"===a)n=
QTLTrack(f,g,a,1),f.addTrackList(n);else if("trx"===a)g=getAllChildrenByName(getFirstChildByName(f.selectedData,"TranscriptList"),"Transcript"),n=TranscriptTrack(f,g,a,b),f.addTrackList(n);else if("probe"===a||"probeMouse"===a)99!==f.levelNumber&&(c=b+","+c),n=ProbeTrack(f,g,a,"Affy Exon 1.0 ST Probe Sets",c),f.addTrackList(n);else if(-1<a.indexOf("spliceJnct"))c="Brain ","liverspliceJnct"===a?c="Liver ":"heartspliceJnct"===a&&(c="Heart "),n=SpliceJunctionTrack(f,g,a,c+"Splice Junctions",3,""),100===
f.levelNumber&&(n.density=b),f.addTrackList(n);else if("polyASite"===a)n=PolyATrack(f,g,a,"Predicted PolyA Sites",c),f.addTrackList(n);else if("helicos"===a||-1<a.indexOf("illuminaTotal")||-1<a.indexOf("illuminaSmall")||"illuminaPolyA"===a){f.updateTimeoutHandle[a]&&(f.updateTimeoutHandle[a]=-1);b=2;c=d.split(",");1<c.length&&(1===c[1]||2===c[1])&&(b=c[1]);"helicos"===a?n=HelicosTrack(f,g,a,b):"illuminaTotal"===a?n=IlluminaTotalTrack(f,g,a,b):"illuminaSmall"===a?n=IlluminaSmallTrack(f,g,a,b):"illuminaPolyA"===
a?n=IlluminaPolyATrack(f,g,a,b):"liverilluminaTotalPlus"===a?n=LiverIlluminaTotalPlusTrack(f,g,a,b):"liverilluminaTotalMinus"===a?n=LiverIlluminaTotalMinusTrack(f,g,a,b):"heartilluminaTotalPlus"===a?n=HeartIlluminaTotalPlusTrack(f,g,a,b):"heartilluminaTotalMinus"===a?n=HeartIlluminaTotalMinusTrack(f,g,a,b):"brainilluminaTotalPlus"===a?n=BrainIlluminaTotalPlusTrack(f,g,a,b):"brainilluminaTotalMinus"===a?n=BrainIlluminaTotalMinusTrack(f,g,a,b):"liverilluminaSmall"===a?n=LiverIlluminaSmallTrack(f,g,
a,b):"heartilluminaSmall"===a?n=HeartIlluminaSmallTrack(f,g,a,b):-1<a.indexOf("illuminaTotal")&&(n=StrainSpecificIlluminaTotalTrack(f,g,a,b));if(99===f.levelNumber){if(0!==f.updateTimeoutHandle[a]){clearTimeout(f.updateTimeoutHandle[a]);try{clearTimeout(f.timeoutTrack[a].fullDataTimeOutHandle)}catch(E){}f.updateTimeoutHandle[a]=0}f.updateTimeoutHandle[a]=setTimeout(function(){n.updateFullData(0,1);f.timeoutTrack[a]=n;f.updateTimeoutHandle[a]=0},300)}f.addTrackList(n)}else if(0===a.indexOf("repeatMask"))n=
RepeatMaskTrack(f,g,a,"Repeat Masker",1,c),f.addTrackList(n);else if(-1<a.indexOf("custom"))if(b=trackInfo[a],c="DataFile="+b.Location+","+c,"bed"===b.Type||"bb"===b.Type)g=[],n=CustomTranscriptTrack(f,g,a,b.Name,3,c),f.addTrackList(n);else if("bg"===b.Type||"bw"===b.Type)g=[],n=CustomCountTrack(f,g,a,3,c),f.addTrackList(n);$(".sortable"+f.levelNumber).sortable("refresh")};f.addTrackList=function(a){null!=a&&(f.trackList[f.trackCount]=a,f.trackCount++,setTimeout(function(){DisplayRegionReport()},
300))};f.changeTrackHeight=function(a,b){0<b?d3.select("#"+a+"Scroll").style("max-height",b+"px"):d3.select("#"+a+"Scroll").style("max-height","none")};f.removeAllTracks=function(){for(var a=0;a<f.trackList.length;a++)"undefined"!==typeof f.trackList[a]&&"genomeSeq"!==f.trackList[a].trackClass&&d3.select("#Level"+f.levelNumber+f.trackList[a].trackClass).remove();f.trackList=[];setTimeout(function(){DisplayRegionReport()},300)};f.removeTrack=function(a){d3.select("#Level"+f.levelNumber+a).remove();
for(var b=0;b<f.trackList.length;b++)"undefined"!==typeof f.trackList[b]&&f.trackList[b].trackClass==a&&(f.trackList.splice(b,1),f.trackCount--);setTimeout(function(){DisplayRegionReport()},300)};f.redrawTrack=function(a){for(var b=0;b<f.trackList.length;b++)"undefined"!==typeof f.trackList[b]&&f.trackList[b].trackClass==a&&f.trackList[b].redraw();setTimeout(function(){DisplayRegionReport()},300)};f.redraw=function(){for(var a=0;a<f.trackList.length;a++)"undefined"!==typeof f.trackList[a]&&"undefined"!==
...
(new String(f.folderName)).indexOf("img")&&$.ajax({url:pathPrefix+"getFullPath.jsp",type:"GET",async:!1,data:{chromosome:chr,minCoord:f.xScale.domain()[0],maxCoord:f.xScale.domain()[1],panel:panel,rnaDatasetID:rnaDatasetID,arrayTypeID:arrayTypeID,myOrganism:organism,genomeVer:genomeVer},dataType:"json",success:function(a){f.folderName=a.folderName},error:function(a,b,c){}});for(var a=0;a<f.trackList.length;a++)"undefined"!==typeof f.trackList[a]&&"undefined"!==typeof f.trackList[a].updateFullData&&
...
f.xScale.domain()[0];f.prevMaxCoord=f.xScale.domain()[1];var a=d3.mouse(f.vis.node());f.downx=f.xScale.invert(a[0]);f.downscalex=f.xScale}};f.forceDrawAs=function(a){for(var b=0;b<f.trackList.length;b++)"undefined"!==typeof f.trackList[b]&&"undefined"!==typeof f.trackList[b].drawAs&&(f.trackList[b].drawAs=a,f.trackList[b].draw(f.trackList[b].data));f.forceDrawAsValue=a};f.generateSettingsString=function(){ret="";for(var a=0;a<f.trackList.length;a++)"undefined"!==typeof f.trackList[a]&&"undefined"!==
...
.95);d3.select(".testToolTip").html("Name: "+a.data.names+"<BR>Count: "+a.data.value).style("left",d3.event.pageX+"px").style("top",d3.event.pageY+20+"px");b.triggerTableFilter(a)}).on("mouseout",function(a){d3.select(".testToolTip").transition().delay(500).duration(200).style("opacity",0);b.clearTableFilter(a)});a.append("text").attr("transform",function(a){return"translate("+d.centroid(a)+")"}).attr("dy",".35em").attr("fill","#FFFFFF").style("text-anchor","middle").text(function(a){var b=a.value;
0==a.value&&(b="");return b})}}};b.updateLabel=function(a){b.label=a;a=new String(b.label);600<b.gsvg.width?d3.select("#Level"+b.gsvg.levelNumber+b.trackClass).select("#trkLbl").attr("x",b.gsvg.width/2-a.length/2*7.5).text(a):d3.select("#Level"+b.gsvg.levelNumber+b.trackClass).select("#trkLbl").attr("x",0).text(a);d3.select("#Level"+b.gsvg.levelNumber+b.trackClass).select(".infoIcon").attr("transform","translate("+(b.gsvg.width-20)+",0)");d3.select("#Level"+b.gsvg.levelNumber+b.trackClass).select(".settings").attr("transform",
...
"G"};b.translate=function(a){a=a.toUpperCase();return b.codons[a]};b.translateRegion=function(a,c,f,d){var n=[],k=0,g=0;if(b.data){if(f>d){g=1;var e=f;f=d;d=e}for(e=f;e<=d;e+=3){var m=b.data.substring(e,e+3);1==g&&(m=b.reverseCompliment(m));n[k]=[];n[k].aa=b.translate(m);n[k].pos=c+(e-f);n[k].id=a+":"+e+":"+b.translate(m);k++}}return n};b.reverseCompliment=function(a){for(var c="",f=a.length-1;-1<f;f--)c+=b.complement(a.charAt(f));return c};b.complement=function(a){var b="N";"A"==a?b="T":"T"==a?b=
"A":"G"==a?b="C":"C"==a&&(b="G");return b};b.redraw=function(){b.redrawSelectedArea();var a=b.xScale.domain()[0],c=b.xScale.domain()[1];if(b.prevStrand!=b.strands||b.prevIncldAA!=b.includeAA)d3.select("#Level"+b.gsvg.levelNumber+b.trackClass).selectAll("g.base").each(function(a){d3.select(this).remove()}),d3.select("#Level"+b.gsvg.levelNumber+b.trackClass).selectAll("g.aa0").each(function(a){d3.select(this).remove()}),d3.select("#Level"+b.gsvg.levelNumber+b.trackClass).selectAll("g.aa1").each(function(a){d3.select(this).remove()}),
...
b.updateData(0):b.draw(b.data);else if(a<b.seqRegionMin||c>b.seqRegionMax)b.updateData(0);else{var f=c-a,d="12px";200<f&&(d="10px");if(f<=b.aaDispCutoff&&1==b.includeAA||f<=b.dispCutoff){if(b.seqRegionMin<=a&&a<=b.seqRegionMax&&b.seqRegionMin<=c&&c<=b.seqRegionMax){var n=b.gsvg.width/f,k=n/2;c=a-b.seqRegionMin;var g=f+c,e=27;1==b.includeAA&&"-"!=b.strands&&(e+=30);if(f<b.dispCutoff){d3.select("#Level"+b.gsvg.levelNumber+b.trackClass).selectAll("g.line").remove();for(var m=[],r=c;r<g;r++)m[r-c]=[],
m[r-c].base=b.data.charAt(r),m[r-c].id=r,m[r-c].pos=r-c;b.textSize(f);var h=b.yPosition(f);r=b.svg.selectAll(".base").data(m,keyID).attr("transform",function(a,b){return"translate("+(a.pos*n-k)+","+e+")"});m=r.enter().append("g").attr("class","base").attr("transform",function(a,b){return"translate("+(a.pos*n-k)+","+e+")"});m.each(function(a){d3.select(this).append("text").text(function(a){return"-"!=b.strands?a.base:b.complement(a.base)});"both"==b.strands&&d3.select(this).append("text").attr("class",
"comp").attr("y",h).text(function(a){return b.complement(a.base)})});r.exit().remove();r.selectAll("text").attr("font-size",function(a){return b.textSize(f)});r.selectAll("text.comp").attr("y",h)}else d3.select("#Level"+b.gsvg.levelNumber+b.trackClass).selectAll("g.base").remove(),b.svg.append("g").attr("class","line").append("line").attr("stroke","#000000").attr("x1",0).attr("y1",e).attr("x2",b.gsvg.width).attr("y2",e);if(1==b.includeAA){var l=3*n,p=l/2-4,t=25;if("both"==b.strands||"+"==b.strands)for(r=
a%3,m=c-r,g=[],g[0]=b.translateRegion(0,a-r,m,m+f),g[1]=b.translateRegion(1,a-r-1,m-1,m-1+f),g[2]=b.translateRegion(2,a-r-2,m-2,m-2+f),t=25,r=0;3>r;r++){var u=b.svg.selectAll(".aa"+r).data(g[r],keyID).attr("transform",function(a,c){return"translate("+(b.xScale(a.pos)-n)+","+t+")"}).each(function(a){d3.select(this).select("rect").attr("width",l);f<b.dispCutoff?0==d3.select(this).select("text").size()?d3.select(this).append("text").attr("x",p).attr("font-size",d).text(function(a){return a.aa}):d3.select(this).select("text").attr("x",
p).attr("font-size",d):d3.select(this).select("text").remove()});m=u.enter().append("g").attr("class","aa"+r).attr("transform",function(a,c){return"translate("+(b.xScale(a.pos)-n)+","+t+")"});m.each(function(a){d3.select(this).append("rect").attr("y",-10).attr("height",10).attr("width",l).attr("stroke",b.colorAA).attr("fill",b.colorAA);f<b.dispCutoff&&d3.select(this).append("text").attr("x",p).attr("font-size",d).text(function(a){return a.aa})});u.exit().remove();t+=11}t="both"==b.strands?80:45;if("both"==
b.strands||"-"==b.strands)for(r=a%3,m=c-r,g=[],g[0]=b.translateRegion(0,a-r,m+f,m),g[1]=b.translateRegion(1,a-r-1,m-1+f,m-1),g[2]=b.translateRegion(2,a-r-2,m-2+f,m-2),r=0;3>r;r++)u=b.svg.selectAll(".aarev"+r).data(g[r],keyID).attr("transform",function(a,c){return"translate("+(b.xScale(a.pos)-n)+","+t+")"}).each(function(a){d3.select(this).select("rect").attr("width",l);f<b.dispCutoff?0==d3.select(this).select("text").size()?d3.select(this).append("text").attr("x",p).attr("font-size",d).text(function(a){return a.aa}):
d3.select(this).select("text").attr("x",p).attr("font-size",d):d3.select(this).select("text").remove()}),m=u.enter().append("g").attr("class","aarev"+r).attr("transform",function(a,c){return"translate("+b.xScale(a.pos)+","+t+")"}),m.each(function(a){d3.select(this).append("rect").attr("y",-10).attr("height",10).attr("width",l).attr("stroke",b.colorAA).attr("fill",b.colorAA);f<b.dispCutoff&&d3.select(this).append("text").attr("x",p).attr("font-size",d).text(function(a){return a.aa})}),u.exit().remove(),
...
-10).attr("height",10).attr("width",l).attr("stroke",b.colorAA(a)).attr("fill",b.colorAA(a));f<b.dispCutoff&&d3.select(this).append("text").attr("x",p).attr("font-size",n).text(function(b){return a.aa})}),k.exit().remove(),t+=11;"both"==b.strands?b.svg.attr("height",125):b.svg.attr("height",75)}else"both"==b.strands?b.svg.attr("height",45):b.svg.attr("height",30);b.prevStrand=b.strands;b.prevIncldAA=b.includeAA;$("li.draggable"+b.gsvg.levelNumber+"#li"+b.trackClass).show()}else b.svg.attr("height",
0),$("li.draggable"+b.gsvg.levelNumber+"#li"+b.trackClass).hide()};b.textSize=function(a){var b="9px";100>=a?b="11px":150>=a?b="8px":200>=a?b="6.8px":250>=a?b="5.8px":300>=a&&(b="4.8px");return b};b.yPosition=function(a){var b=12;100>=a?b=12:150>=a?b=10:200>=a?b=8:250>=a?b=6:300>=a&&(b=5);return b};b.updateData=function(a){var c=(new Date).getTime();if(25E3<c-b.lastUpdate||0<a)0===a&&(0===b.lastUpdate||25E3>c-b.lastUpdate)&&(b.tmpseqRegionMin=b.xScale.domain()[0]-b.seqRegionSize,b.tmpseqRegionMax=
...
a.ttTrackList.push("illuminaPolyA")):"liverTotal"===l?(a.ttTrackList.push("liverspliceJnct"),a.ttTrackList.push("liverilluminaTotalPlus"),a.ttTrackList.push("liverilluminaTotalMinus")):"heartTotal"===l?(a.ttTrackList.push("heartspliceJnct"),a.ttTrackList.push("heartilluminaTotalPlus"),a.ttTrackList.push("heartilluminaTotalMinus")):"brainTotal"===l?(a.ttTrackList.push("brainspliceJnct"),a.ttTrackList.push("brainilluminaTotalPlus"),a.ttTrackList.push("brainilluminaTotalMinus")):"brainsmallnc"===l?a.ttTrackList.push("illuminaSmall"):
"heartsmallnc"===l?a.ttTrackList.push("heartilluminaSmall"):"liversmallnc"===l&&a.ttTrackList.push("liverilluminaSmall");a.pieColorPalette=d3.scaleOrdinal(d3.schemeCategory20);a.color=function(b){var c="#000000";"ensemblcoding"===a.trackClass?c="#DFC184":"braincoding"===a.trackClass?(c="#7EB5D6",null!==b.getAttribute("strain")&&"undefined"!==typeof b.getAttribute("strain")&&"All"!==b.getAttribute("strain")&&(c=a.strainSpecColor(c,b))):"ensemblnoncoding"===a.trackClass?c="#B58AA5":"brainnoncoding"===
a.trackClass?(c="#CECFCE",null!==b.getAttribute("strain")&&"undefined"!==typeof b.getAttribute("strain")&&"BNLX"===b.getAttribute("strain").toUpperCase()?c="#3E75FF":null===b.getAttribute("strain")||"undefined"===typeof b.getAttribute("strain")||"SHR"!==b.getAttribute("strain").toUpperCase()&&"SHRH"!==b.getAttribute("strain").toUpperCase()||(c="#FE7596")):"ensemblsmallnc"===a.trackClass?c="#FFCC00":"brainsmallnc"===a.trackClass?(c="#3E7596",null!==b.getAttribute("strain")&&"undefined"!==typeof b.getAttribute("strain")&&
"All"!==b.getAttribute("strain")&&(c=a.strainSpecColor(c,b))):"liverTotal"===a.trackClass?(c="#bbbedd",null!==b.getAttribute("strain")&&"undefined"!==typeof b.getAttribute("strain")&&"All"!==b.getAttribute("strain")&&(c=a.strainSpecColor(c,b))):"heartTotal"===a.trackClass?(c="#DC7252",null!==b.getAttribute("strain")&&"undefined"!==typeof b.getAttribute("strain")&&"All"!==b.getAttribute("strain")&&(c=a.strainSpecColor(c,b))):"brainTotal"===a.trackClass?(c="#7EB5D6",null!==b.getAttribute("strain")&&
"undefined"!==typeof b.getAttribute("strain")&&"All"!==b.getAttribute("strain")&&(c=a.strainSpecColor(c,b))):"liversmallnc"===a.trackClass?(c="#7b7e9d",null!==b.getAttribute("strain")&&"undefined"!==typeof b.getAttribute("strain")&&"All"!==b.getAttribute("strain")&&(c=a.strainSpecColor(c,b))):"heartsmallnc"===a.trackClass?(c="#9C3212",null!==b.getAttribute("strain")&&"undefined"!==typeof b.getAttribute("strain")&&"All"!==b.getAttribute("strain")&&(c=a.strainSpecColor(c,b))):"mergedTotal"===a.trackClass&&
(c="#9F4F92");return c=d3.rgb(c)};a.strainSpecColor=function(a,b){var c=parseInt(a.substr(1,2),16),f=parseInt(a.substr(3,2),16),k=parseInt(a.substr(5),16);if("BNLX"===b.getAttribute("strain").toUpperCase())k+=64,c-=32,f-=32;else if("SHR"===b.getAttribute("strain").toUpperCase()||"SHRH"===b.getAttribute("strain").toUpperCase())c+=64,k-=32,f-=32;255<c&&(c=255);255<f&&(f=255);255<k&&(k=255);return"#"+c.toString(16)+f.toString(16)+k.toString(16)};a.pieStrainSpecColor=function(a,b){var c=parseInt(a.substr(1,
2),16),f=parseInt(a.substr(3,2),16),k=parseInt(a.substr(5),16);if("BNLX"===b.toUpperCase())k+=64,c-=32,f-=32;else if("SHR"===b.toUpperCase()||"SHRH"===b.toUpperCase())c+=64,k-=32,f-=32;255<c&&(c=255);255<f&&(f=255);255<k&&(k=255);return a="#"+c.toString(16)+f.toString(16)+k.toString(16)};a.pieColor=function(b,f){var c="#000000";"ensemblcoding"===a.trackClass?c="#DFC184":"braincoding"===a.trackClass?c=a.pieStrainSpecColor("#7EB5D6",b.data.names):"ensemblnoncoding"===a.trackClass?c="#B58AA5":"brainnoncoding"===
a.trackClass?(c="#CECFCE",null!==b.data.names&&"undefined"!==typeof b.data.names&&"BNLX"===b.data.names.toUpperCase()?c="#3E75FF":null===b.data.names||"undefined"===typeof b.data.names||"SHR"!==b.data.names.toUpperCase()&&"SHRH"!==b.data.names.toUpperCase()||(c="#FE7596")):"ensemblsmallnc"===a.trackClass?c=a.pieColorPalette(b.data.names):"brainsmallnc"===a.trackClass?c=a.pieStrainSpecColor("#99CC99",b.data.names):"liverTotal"===a.trackClass?c=a.pieStrainSpecColor("#bbbedd",b.data.names):"heartTotal"===
a.trackClass?c=a.pieStrainSpecColor("#DC7252",b.data.names):"brainTotal"===a.trackClass?c=a.pieStrainSpecColor("#7EB5D6",b.data.names):"liversmallnc"===a.trackClass?c=a.pieStrainSpecColor("#8b8ead",b.data.names):"heartsmallnc"===a.trackClass?c=a.pieStrainSpecColor("#BC5232",b.data.names):"mergedTotal"===a.trackClass&&(c="#9F4F92");return c=d3.rgb(c)};a.getDisplayID=function(b){-1<a.trackClass.indexOf("smallnc")||-1<b.indexOf("_")&&(b=b.substr(b.indexOf("_")+1));return b};a.createToolTip=function(b){var c=
"";if(-1<a.trackClass.indexOf("smallnc")){c="Known - "+b.getAttribute("biotype");var d=".";1==b.getAttribute("strand")?d="+":-1==b.getAttribute("strand")&&(d="-");if(0===(new String(b.getAttribute("ID"))).indexOf("P")){var n=getAllChildrenByName(getFirstChildByName(b,"TranscriptList"),"Transcript");getAllChildrenByName(getFirstChildByName(b,"StrainQuantList"),"Strains")[1].getAttribute("strain");c=n[0].getAttribute("category")+" - "+n[0].getAttribute("source")}n='<BR><div id="ttSVG" style="background:#FFFFFF;"></div>ID: '+
b.getAttribute("ID");-1===a.trackClass.indexOf("ensembl")&&(n=n+"<BR>PhenoGen ID: "+b.getAttribute("intGeneID"));n=n+"<BR>Length: "+(b.getAttribute("stop")-b.getAttribute("start"))+"<BR>Type:"+c+"<BR>Location: "+b.getAttribute("chromosome")+":"+numberWithCommas(b.getAttribute("start"))+"-"+numberWithCommas(b.getAttribute("stop"))+"<BR>Strand: "+d+"<BR>"}else{var k=b.getAttribute("ID");k=a.getDisplayID(k);var g="";b.getAttribute("geneSymbol")?g=b.getAttribute("geneSymbol"):b.parent&&b.parent.getAttribute("geneSymbol")&&
(g=b.parent.getAttribute("geneSymbol"));d=".";1==b.getAttribute("strand")?d="+":-1==b.getAttribute("strand")&&(d="-");if(b.parent){n=getAllChildrenByName(getFirstChildByName(b.parent,"TranscriptList"),"Transcript");for(var e=0;e<n.length;e++){var m=new String(n[e].getAttribute("ID"));k!=m&&(-1<(new String(n[e].getAttribute("ID"))).indexOf("ENS")?c+="<B>"+m+"</B>":(c+="<B>"+m+"</B>",-1==(new String(n[e].getAttribute("ID"))).indexOf("ENS")&&(m=getFirstChildByName(getFirstChildByName(n[e],"annotationList"),
"annotation"),null!=m&&(c+=" - "+m.getAttribute("reason")))),c+="<br>");if(""==g){m=getAllChildrenByName(getFirstChildByName(n[e],"annotationList"),"annotation");for(var r=0;r<m.length&&""==g;r++)"AKA"==m[r].getAttribute("source")&&(g=m[r].getAttribute("annot_value"),g=(new String(g)).split(":"),g=0!=(new String(g[g.length-1])).indexOf("ENS")?g[g.length-1]:g[0])}}n='<BR><div id="ttSVG" style="background:#FFFFFF;overflow:"></div><BR>Transcript ID: '+k+"<BR>Location: "+b.getAttribute("chromosome")+
":"+numberWithCommas(b.getAttribute("start"))+"-"+numberWithCommas(b.getAttribute("stop"))+"<BR>Strand: "+d;n=n+"<BR><BR>Gene Symbol: "+g+"<BR>Gene ID: "+a.getDisplayID(b.parent.getAttribute("ID"))+"<BR><BR>Other Transcripts:<BR>"+c+"<BR>"}else{n=getAllChildrenByName(getFirstChildByName(b,"TranscriptList"),"Transcript");for(e=0;e<n.length;e++)if(m=new String(n[e].getAttribute("ID")),-1<(new String(n[e].getAttribute("ID"))).indexOf("ENS")?c+="<B>"+m+"</B>":(c+="<B>"+m+"</B>",-1===(new String(n[e].getAttribute("ID"))).indexOf("ENS")&&
(m=getFirstChildByName(getFirstChildByName(n[e],"annotationList"),"annotation"),null!=m&&(c+=" - "+m.getAttribute("reason")))),c+="<br>",0===g.length)for(m=getAllChildrenByName(getFirstChildByName(n[e],"annotationList"),"annotation"),r=0;r<m.length&&0===g.length;r++)"AKA"===m[r].getAttribute("source")&&(g=m[r].getAttribute("annot_value"),g=(new String(g)).split(":"),g=0!==(new String(g[g.length-1])).indexOf("ENS")?g[g.length-1]:g[0]);n='<BR><div id="ttSVG" style="background:#FFFFFF;overflow:scroll;max-height:400px;"></div>Gene ID: '+
k+"<BR>Gene Symbol: "+g+"<BR>Location: "+b.getAttribute("chromosome")+":"+numberWithCommas(b.getAttribute("start"))+"-"+numberWithCommas(b.getAttribute("stop"))+"<BR>Strand: "+d+"<BR><BR>Transcripts:<BR>"+c+"<BR>"}"brainTotal"!==a.trackClass&&"liverTotal"!==a.trackClass||!(-1<b.getAttribute("ID").indexOf("PRN6T")||-1<b.getAttribute("ID").indexOf("PRN6G"))||(d="Gene",-1<b.getAttribute("ID").indexOf("PRN6T")&&(d="Transcript"),n=n+'<div>Heritability: <span id="ttsingleHerit"></span></div>'+d+' Expression:<BR><div style="text-align:center;">Median Estimated Counts Per Million</div><div id="ttChart"></div>',
c="Brain",k="Whole Brain","liverTotal"===a.trackClass&&(k=c="Liver"),tmpChart=chart({data:"tmpData/browserCache/"+genomeVer+"/regionData/"+a.gsvg.folderName+"/"+c+"expr.json",selector:"#ttChart",allowResize:!1,type:"scatter",width:"400",height:"275",displayHerit:!1,displayControls:!1,title:d+" Expression",titlePrefix:k,filterID:b.getAttribute("ID")}))}return n};a.redraw=function(){a.yMaxArr=[];a.yArr=[];a.yArr[0]=[];for(var b=0;b<a.gsvg.width;b++)a.yMaxArr[b]=0,a.yArr[0][b]=0;a.trackYMax=0;b=a.xScale.domain()[0];
b=a.xScale.domain()[1]-b;var f=0;if(a.reqDataVer!==a.dataVer)a.updateDataVersion(a.reqDataVer,0);else if("undefined"!==typeof a.prevSetting&&a.prevSetting.density!==a.density)a.draw(a.data);else if(b<a.trxCutoff&&"Gene"===a.drawnAs||b>=a.trxCutoff&&"Trx"===a.drawnAs&&"Trx"!==a.drawAs||"Gene"===a.drawnAs&&$("#forceTrxCBX"+a.gsvg.levelNumber).is(":checked"))a.draw(a.data);else if(b<a.trxCutoff&&"Trx"===a.drawnAs&&"Trx"!==a.drawAs&&(f=1),"Gene"===a.drawAs&&0===f||-1<a.trackClass.indexOf("smallnc"))a.svg&&
(d3.select("#Level"+a.gsvg.levelNumber+a.trackClass).selectAll("g.gene").attr("transform",function(b,c){return"translate("+a.xScale(b.getAttribute("start"))+","+a.calcY(parseInt(b.getAttribute("start"),10),parseInt(b.getAttribute("stop"),10),c)+")"}),d3.select("#Level"+a.gsvg.levelNumber+a.trackClass).selectAll("g.gene rect").attr("width",function(b){var c=1;1<a.xScale(b.getAttribute("stop"))-a.xScale(b.getAttribute("start"))&&(c=a.xScale(b.getAttribute("stop"))-a.xScale(b.getAttribute("start")));
return c}).attr("stroke",a.colorStroke),d3.select("#Level"+a.gsvg.levelNumber+a.trackClass).selectAll("g.gene").each(function(b){var c=d3.select(this),d=parseInt(b.getAttribute("strand"),10);if(-1===d||1===d){var f=">";-1===d&&(f="<");d="";var e=c.select("rect").attr("width");if(8.3<=e&&15.8>=e)d=f;else for(;8.5<e;)d+=f,e-=8.5;c.select("text#strandTxt").text(d)}if(2===a.density){var m=b.getAttribute("ID");b.getAttribute("geneSymbol")&&0<b.getAttribute("geneSymbol").length&&(m=m+" ("+b.getAttribute("geneSymbol")+
")");0===c.select("text#lblTxt").size()?c.append("svg:text").attr("dx",function(){var c=a.xScale(b.getAttribute("start"));return c=c<$(window).width()/2?a.xScale(b.getAttribute("stop"))-a.xScale(b.getAttribute("start"))+5:-9*m.length}).attr("dy",10).attr("id","lblTxt").text(m):c.select("text#lblTxt").attr("dx",function(){var c=a.xScale(b.getAttribute("start"));return c=c<$(window).width()/2?a.xScale(b.getAttribute("stop"))-a.xScale(b.getAttribute("start"))+5:-9*m.length})}else c.select("text#lblTxt").remove()})),
1===a.density?a.svg.attr("height",30):2===a.density?a.svg.attr("height",15*(a.trackYMax+1)):3===a.density&&a.svg.attr("height",15*(a.trackYMax+1));else if(1===f||"Trx"===a.drawAs)a.svg.selectAll(".trx"+a.gsvg.levelNumber).attr("transform",function(b,c){return"translate(0,"+a.calcY(parseInt(b.getAttribute("start"),10),parseInt(b.getAttribute("stop"),10),c)+")"}).each(function(b,c){var d=parseInt(b.getAttribute("start"),10),f=parseInt(b.getAttribute("stop"),10);b.getAttribute("cdsStart")&&b.getAttribute("cdsStop")&&
(d=parseInt(b.getAttribute("cdsStart"),10),f=parseInt(b.getAttribute("cdsStop"),10));exList=getAllChildrenByName(getFirstChildByName(b,"exonList"),"exon");var n="";1===a.gsvg.levelNumber?n="tx":99===a.gsvg.levelNumber&&(n="ttTx");for(var e=0;e<exList.length;e++){var r=exList[e].getAttribute("start"),h=exList[e].getAttribute("stop");if(r<d&&d<h||h>f&&f>r){var l=r,p=d;h>f?(l=f,p=h,h=f):r=d;d3.select("#Level"+a.gsvg.levelNumber+a.trackClass+" g#"+n+b.getAttribute("ID")+a.gsvg.levelNumber+" rect#ExNC"+
exList[e].getAttribute("ID")).attr("x",function(b){return a.xScale(l)}).attr("width",function(b){return a.xScale(p)-a.xScale(l)})}d3.select("#Level"+a.gsvg.levelNumber+a.trackClass+" g#"+n+b.getAttribute("ID")+a.gsvg.levelNumber+" rect#Ex"+exList[e].getAttribute("ID")).attr("x",function(b){return a.xScale(r)}).attr("width",function(b){return a.xScale(h)-a.xScale(r)});if(0<e){var t=">";"-1"==b.getAttribute("strand")&&(t="<");var u=t,C=a.xScale(exList[e-1].getAttribute("stop")),D=a.xScale(exList[e].getAttribute("start")),
y=D-C,B=0;if(7>y||"0"==b.getAttribute("strand")||"."==b.getAttribute("strand"))u="";else for(y-=7;8<y;)0===B?(u+=" ",B=1):(u+=t,B=0),y-=7;d3.select("#Level"+a.gsvg.levelNumber+a.trackClass+" g.trx"+a.gsvg.levelNumber+"#"+n+b.getAttribute("ID")+a.gsvg.levelNumber+" line#Int"+exList[e-1].getAttribute("ID")+"_"+exList[e].getAttribute("ID")).attr("x1",C).attr("x2",D);d3.select("#Level"+a.gsvg.levelNumber+a.trackClass+" g.trx"+a.gsvg.levelNumber+"#"+n+b.getAttribute("ID")+a.gsvg.levelNumber+" #IntTxt"+
exList[e-1].getAttribute("ID")+"_"+exList[e].getAttribute("ID")).attr("dx",C+1).text(u)}}if(2===a.density){var z=b.getAttribute("ID");b.getAttribute("geneSymbol")&&0<b.getAttribute("geneSymbol").length&&(z=z+" ("+b.getAttribute("geneSymbol")+")");0===d3.select("#Level"+a.gsvg.levelNumber+a.trackClass+" g.trx"+a.gsvg.levelNumber+"#"+n+b.getAttribute("ID")+a.gsvg.levelNumber+" text#lblTxt").size()?d3.select("#Level"+a.gsvg.levelNumber+a.trackClass+" g.trx"+a.gsvg.levelNumber+"#"+n+b.getAttribute("ID")+
a.gsvg.levelNumber).append("svg:text").attr("dx",function(){var c=a.xScale(b.parent.getAttribute("start"));return c=c<$(window).width()/2?a.xScale(b.parent.getAttribute("stop"))-a.xScale(b.parent.getAttribute("start"))+5:-9*z.length}).attr("dy",10).attr("id","lblTxt").text(z):d3.select("#Level"+a.gsvg.levelNumber+a.trackClass+" g.trx"+a.gsvg.levelNumber+"#"+n+b.getAttribute("ID")+a.gsvg.levelNumber+" text#lblTxt").attr("dx",function(){var c=a.xScale(b.getAttribute("start"));return c=c<$(window).width()/
2?a.xScale(b.getAttribute("stop"))-a.xScale(b.getAttribute("start"))+5:-9*z.length})}else d3.select("#Level"+a.gsvg.levelNumber+a.trackClass+" g.trx"+a.gsvg.levelNumber+"#"+n+b.getAttribute("ID")+a.gsvg.levelNumber+" text#lblTxt").remove()}),1===a.density?a.svg.attr("height",30):2===a.density?a.svg.attr("height",15*(a.trackYMax+1)):3===a.density&&a.svg.attr("height",15*(a.trackYMax+1));a.redrawSelectedArea()};a.setSelected=function(b){if(b)if(0<d3.selectAll("g.gene").size()){if(d3.selectAll("rect.selected").each(function(){d3.select(this).attr("class",
"").style("fill",a.color)}),b=d3.select("g.gene rect#"+b))b.attr("class","selected").style("fill","green"),a.setupDetailedView(b.data()[0]),selectGene=""}else if(0<d3.selectAll("g.trx"+a.gsvg.levelNumber).size()){var c=(new String(b)).replace(".","_");a.svg.selectAll("g.trx"+a.gsvg.levelNumber+".selected").selectAll("line").style("stroke",a.color);a.svg.selectAll("g.trx"+a.gsvg.levelNumber+".selected").selectAll("rect").style("fill",a.color);a.svg.selectAll("g.trx"+a.gsvg.levelNumber+".selected").selectAll("text").style("opacity",
"0.6").style("fill",a.color);a.svg.selectAll("g.trx"+a.gsvg.levelNumber+".selected").each(function(){var a=new String($(this).attr("class"));a=a.replace(" selected","");$(this).attr("class",a)});a.svg.selectAll("g.gene"+c).each(function(){var a=$(this).attr("class")+" selected";$(this).attr("class",a)});a.svg.selectAll("g.gene"+c).selectAll("line").style("stroke","green");a.svg.selectAll("g.gene"+c).selectAll("rect").style("fill","green");a.svg.selectAll("g.gene"+c).selectAll("text").style("opacity",
"0.3").style("fill","green");a.svg.selectAll("g.gene"+c)&&((c=a.svg.selectAll("g.gene"+c).data())&&0<c.length?a.setupDetailedView(c[0].parent):(console.log("tmp[0]"),console.log(c),Rollbar.debug("tmp[0] is undefined.  tmp.length is "+c.length+":"+b+":"+a.gsvg.levelNumber+":"+a.trackClass)));selectGene=""}};a.clearSelection=function(){a.selectionStart=-1;a.selectionEnd=-1;a.svg.selectAll("rect.selectedArea").remove();0<a.svg.selectAll("g.gene").size()?a.svg.selectAll("rect.selected").each(function(b){d3.select(this).attr("class",
...
a=a.replace(" selected","");$(this).attr("class",a)}))};a.setupDetailedView=function(b){if(b){a.gsvg.clearSelection();jQuery.Event("keyup").which=32;var c=a.gsvg.levelNumber+1;$("div#collapsableReport").is(":hidden")||($("div#collapsableReport").hide(),$("span[name='collapsableReport']").removeClass("less"));$("div#selectedDetailHeader").is(":hidden")&&$("div#selectedDetailHeader").show();$("div#selectedDetail").is(":hidden")&&$("div#selectedDetail").show();var d="none";"liverTotal"===a.trackClass?
d="liverTotal":"heartTotal"===a.trackClass?d="heartTotal":"brainTotal"===a.trackClass?d="brainTotal":"mergedTotal"===a.trackClass?d="mergedTotal":"protein_coding"===b.getAttribute("biotype")&&200<=b.getAttribute("stop")-b.getAttribute("start")?d="protein":"protein_coding"!==b.getAttribute("biotype")&&200<=b.getAttribute("stop")-b.getAttribute("start")?d="long":200>b.getAttribute("stop")-b.getAttribute("start")&&(d="small");var n=0,k=0;if("protein"===d||"long"===d||"liverTotal"===d||"heartTotal"===
d||"brainTotal"===d||"mergedTotal"===d||"small"===d&&"rn5"!==genomeVer||"small"===d&&-1<(new String(b.getAttribute("ID"))).indexOf("ENS")){console.log("totalType");n=b.getAttribute("ID");var g="";if(b.getAttribute("geneSymbol")&&0<b.getAttribute("geneSymbol").length)n=n+" ("+b.getAttribute("geneSymbol")+")";else{k=getAllChildrenByName(getFirstChildByName(b,"TranscriptList"),"Transcript");for(var e=0;e<k.length&&""===g;e++)if(""===g)for(var m=getAllChildrenByName(getFirstChildByName(k[e],"annotationList"),
"annotation"),r=0;r<m.length&&0===g.length;r++)if("AKA"===m[r].getAttribute("source")){var h=m[r].getAttribute("annot_value");h=(new String(h)).split(":");1<=h.length?(g=h[0],n=n+" ("+g+")"):2<=h.length&&(g=h[0],h=h[1],n=n+" ("+h+")")}}k=parseInt(b.getAttribute("start"),10);m=parseInt(b.getAttribute("stop"),10);b.getAttribute("extStart")&&b.getAttribute("extStop")&&(k=parseInt(b.getAttribute("extStart"),10),m=parseInt(b.getAttribute("extStop"),10));svgViewIDList[c]||(svgViewIDList[c]=a.gsvg.currentView?
a.gsvg.currentView.ViewID:defaultView);e=GenomeSVG("div#selectedImage",a.gsvg.width,k,m,c,n,"transcript");e.xMin=k-.05*(m-k);e.xMax=m+.05*(m-k);n=e.xMin;k=e.xMax;svgList[c]=e;svgList[c].txType=d;svgList[c].selectedData=b;selectedGeneSymbol=b.getAttribute("geneSymbol");selectedID=new String(b.getAttribute("ID"));-1===selectedID.indexOf("ENS")&&0<g.length&&(selectedID=g);$("div#selectedImage").show();console.log("here");-1<(new String(selectedID)).indexOf("ENS")&&-1<a.trackClass.indexOf("ensembl")?
(console.log("geneReport"),$("div#selectedReport").show(),c=pathPrefix+"geneReport.jsp",b={id:selectedID,geneSymbol:selectedGeneSymbol,chromosome:chr,species:organism,genomeVer:genomeVer},DisplaySelectedDetailReport(c,b)):"small"!==d?$("div#selectedReport").html("<BR><BR>Detailed Gene Reports are not currently provided for RNA-Seq(Cufflinks) generated genes that are novel and have not been matched to an existing annotated gene.  In the future overlapping probesets and SNPs will be summarized in the same manner.  This feature should be added by December 2014.  Please keep checking back or let us know you'd like to see it sooner."):
"rn6"===genomeVer&&(b=dataPrefix+"tmpData/browserCache/"+genomeVer+"/regionData/"+a.gsvg.folderName+"/"+a.trackClass+".xml",c=pathPrefix+"smallRNAReport.jsp",b={dataPath:b,id:selectedID},DisplaySelectedDetailReport(c,b))}else"small"===d&&-1===(new String(b.getAttribute("ID"))).indexOf("ENS")&&"rn5"===genomeVer&&($("div#selectedImage").hide(),$("div#selectedReport").show(),n=b.getAttribute("start"),k=b.getAttribute("stop"),c=pathPrefix+"viewSmallNonCoding.jsp",b={id:b.getAttribute("ID"),name:"smRNA_"+
b.getAttribute("ID")},DisplaySelectedDetailReport(c,b));a.gsvg.selectSvg.changeSelection(n,k);$("html, body").animate({scrollTop:$("#selectedDetail").offset().top},200)}};a.getDisplayedData=function(){var b=[],f=0,d=[];if(-1<a.trackClass.indexOf("smallnc")){var n=0;a.counts=[];a.trackClass.indexOf("ensembl");"Gene"===a.drawnAs?d=d3.select("#Level"+a.gsvg.levelNumber+a.trackClass).selectAll("g.gene"):"Trx"===a.drawnAs&&(d=d3.select("#Level"+a.gsvg.levelNumber+a.trackClass).selectAll("g.trx"));d.each&&
d.each(function(c){var d=a.xScale(c.getAttribute("start")),g=a.xScale(c.getAttribute("stop"));if(0<=d&&d<=a.gsvg.width||0<=g&&g<=a.gsvg.width||0>=d&&g>=a.gsvg.width)d="Ensembl","undefined"!==typeof c.getAttribute("strain")?d=c.getAttribute("strain"):"undefined"!==typeof c.getAttribute("biotype")&&(d=c.getAttribute("biotype")),"undefined"===typeof a.counts[d]?(a.counts[d]={},a.counts[n]=a.counts[d],n++,a.counts[d].value=1,a.counts[d].names=d):a.counts[d].value++,b[f]=c,f++,k++})}else if("Gene"===a.drawnAs)d=
d3.select("#Level"+a.gsvg.levelNumber+a.trackClass).selectAll("g.gene"),a.counts=[{value:0,names:"Ensembl"},{value:0,names:"Brain RNA-Seq"},{value:0,names:"Liver RNA-Seq"},{value:0,names:"Heart RNA-Seq"},{value:0,names:"Merged RNA-Seq"}],d.each(function(c){var d=a.xScale(c.getAttribute("start")),g=a.xScale(c.getAttribute("stop"));if(0<=d&&d<=a.gsvg.width||0<=g&&g<=a.gsvg.width)-1<(new String(c.childNodes[0].id)).indexOf("ENS")?a.counts[0].value++:-1<a.trackClass.indexOf("brain")?a.counts[1].value++:
-1<a.trackClass.indexOf("liver")?a.counts[2].value++:-1<a.trackClass.indexOf("heart")?a.counts[3].value++:-1<a.trackClass.indexOf("merged")&&a.counts[4].value++,b[f]=c,f++}),0===d.size()&&(a.counts=[]);else if("Trx"===a.drawnAs){d=d3.select("#Level"+a.gsvg.levelNumber+a.trackClass).selectAll("g.trx"+a.gsvg.levelNumber);a.counts=[];var k=n=0;d.each(function(c){var d=a.xScale(c.getAttribute("start")),g=a.xScale(c.getAttribute("stop"));if(0<=d&&d<=a.gsvg.width||0<=g&&g<=a.gsvg.width||0>=d&&g>=a.gsvg.width)d=
"Ensembl","undefined"!==typeof c.getAttribute("strain")&&(d=c.getAttribute("strain")),"undefined"===typeof a.counts[d]?(a.counts[d]={},a.counts[n]=a.counts[d],n++,a.counts[d].value=1,a.counts[d].names=d):a.counts[d].value++,b[f]=c,f++,k++})}return b};a.updateData=function(b){d3.xml(dataPrefix+"tmpData/browserCache/"+genomeVer+"/regionData/"+a.gsvg.folderName+"/"+a.trackClass+".xml",function(c,d){if(c){if(0===b&&("mergedTotal"===a.trackClass||-1<a.trackClass.indexOf("smallnc"))){var f=contextPath+
"/"+pathPrefix;pathPrefix||(f="");var k=a.trackClass;$.ajax({url:f+"generateTrackXML.jsp",type:"GET",cache:!1,data:{chromosome:chr,minCoord:a.gsvg.xScale.domain()[0],maxCoord:a.gsvg.xScale.domain()[1],panel:panel,rnaDatasetID:rnaDatasetID,arrayTypeID:arrayTypeID,myOrganism:organism,genomeVer:genomeVer,track:k,folder:a.gsvg.folderName},dataType:"json",success:function(a){ga&&ga("send","event","browser","generateTrackGene")},error:function(a,b,c){}})}3>b?(f=1E4,1===b&&(f=15E3),setTimeout(function(){a.updateData(b+
1)},f)):(d3.select("#Level"+a.gsvg.levelNumber+a.trackClass).select("#trkLbl").text("An errror occurred loading Track:"+a.trackClass),d3.select("#Level"+a.gsvg.levelNumber+a.trackClass).attr("height",15),a.gsvg.addTrackErrorRemove(a.svg,"#Level"+a.gsvg.levelNumber+a.trackClass))}else if(d){f=d.documentElement.getElementsByTagName("Gene");k=[];for(var g=[],e=0,m=0;m<f.length;m++)f[m]&&(k[e]=f[m],g[f[m].getAttribute("ID")]=1,e++);for(m=0;m<a.data.length;m++)a.data[m]&&!g[a.data[m].getAttribute("ID")]&&
(k[e]=a.data[m],e++);a.draw(k);a.hideLoading();setTimeout(function(){DisplayRegionReport()},300)}else a.hideLoading()})};a.updateDataVersion=function(b,f){var c=a.trackClass+"_"+b;d3.xml(dataPrefix+"tmpData/browserCache/"+genomeVer+"/regionData/"+a.gsvg.folderName+"/"+c+".xml",function(d,k){if(d){if(0===f){var g=contextPath+"/"+pathPrefix;pathPrefix||(g="");$.ajax({url:g+"generateTrackXML.jsp",type:"GET",cache:!1,data:{chromosome:chr,minCoord:a.gsvg.xScale.domain()[0],maxCoord:a.gsvg.xScale.domain()[1],
panel:panel,rnaDatasetID:rnaDatasetID,arrayTypeID:arrayTypeID,myOrganism:organism,genomeVer:genomeVer,track:c,folder:a.gsvg.folderName},dataType:"json",success:function(a){ga&&ga("send","event","browser","generateTrackGene")},error:function(a,b,c){}})}5>f?(g=1E4,0===f&&(g=5E3),setTimeout(function(){a.updateDataVersion(b,f+1)},g)):(d3.select("#Level"+a.gsvg.levelNumber+a.trackClass).select("#trkLbl").text("An errror occurred loading Track:"+a.trackClass),d3.select("#Level"+a.gsvg.levelNumber+a.trackClass).attr("height",
15),a.gsvg.addTrackErrorRemove(a.svg,"#Level"+a.gsvg.levelNumber+a.trackClass))}else{g=k.documentElement.getElementsByTagName("Gene");var e=parseInt(b);a.dataVer=e;a.draw(g);a.hideLoading();setTimeout(function(){DisplayRegionReport()},300)}})};a.drawTrx=function(b,f){var c=parseInt(b.getAttribute("start"),10),e=parseInt(b.getAttribute("stop"),10);b.getAttribute("cdsStart")&&b.getAttribute("cdsStop")&&(c=parseInt(b.getAttribute("cdsStart"),10),e=parseInt(b.getAttribute("cdsStop"),10));var k="";1===
a.gsvg.levelNumber?k="tx":99===a.gsvg.levelNumber&&(k="ttTx");k=d3.select("#Level"+a.gsvg.levelNumber+a.trackClass+" #"+k+b.getAttribute("ID")+a.gsvg.levelNumber);exList=getAllChildrenByName(getFirstChildByName(b,"exonList"),"exon");for(var g=0;g<exList.length;g++){var q=parseInt(exList[g].getAttribute("start"),10),m=parseInt(exList[g].getAttribute("stop"),10);if(q<c&&c<m||m>e&&e>q){var r=0,h=0,l=0,p=0;q<c?(r=a.xScale(q),h=a.xScale(c)-a.xScale(q),l=a.xScale(c),p=a.xScale(m)-a.xScale(c)):m>e&&(l=a.xScale(q),
p=a.xScale(e)-a.xScale(q),r=a.xScale(e),h=a.xScale(m)-a.xScale(e));k.append("rect").attr("x",r).attr("y",2.5).attr("height",5).attr("width",h).attr("title",function(a){return exList[g].getAttribute("ID")}).attr("id",function(a){return"ExNC"+exList[g].getAttribute("ID")}).style("fill",a.color).style("cursor","pointer");k.append("rect").attr("x",l).attr("height",10).attr("width",p).attr("title",function(a){return exList[g].getAttribute("ID")}).attr("id",function(a){return"Ex"+exList[g].getAttribute("ID")}).style("fill",
a.color).style("cursor","pointer")}else{r=10;h=0;if(q<c&&m<c||m>e&&q>e)r=5,h=2.5;k.append("rect").attr("x",function(b){return a.xScale(exList[g].getAttribute("start"))}).attr("y",h).attr("id",function(a){return"Ex"+exList[g].getAttribute("ID")}).attr("height",r).attr("width",function(b){return a.xScale(exList[g].getAttribute("stop"))-a.xScale(exList[g].getAttribute("start"))}).attr("title",function(a){return exList[g].getAttribute("ID")}).style("fill",a.color).style("cursor","pointer")}if(0<g&&(k.append("line").attr("x1",
function(b){return a.xScale(exList[g-1].getAttribute("stop"))}).attr("x2",function(b){return a.xScale(exList[g].getAttribute("start"))}).attr("y1",5).attr("y2",5).attr("id",function(a){return"Int"+exList[g-1].getAttribute("ID")+"_"+exList[g].getAttribute("ID")}).attr("stroke",a.color).attr("stroke-width","2"),"1"==b.getAttribute("strand")||"-1"==b.getAttribute("strand"))){q=">";if("-1"==b.getAttribute("strand")||"-"==b.getAttribute("strand"))q="<";m=q;r=a.xScale(exList[g-1].getAttribute("stop"));
h=a.xScale(exList[g].getAttribute("start"))-r;l=0;if(7>h)m="";else for(h-=7;8<h;)0==l?(m+=" ",l=1):(m+=q,l=0),h-=7;k.append("svg:text").attr("id",function(a){return"IntTxt"+exList[g-1].getAttribute("ID")+"_"+exList[g].getAttribute("ID")}).attr("dx",r+1).attr("dy","11").style("pointer-events","none").style("opacity","0.5").style("fill",a.color).style("font-size","16px").text(m)}}if(2==a.density){var t=b.getAttribute("ID");"undefined"!==typeof b.getAttribute("geneSymbol")&&0<b.getAttribute("geneSymbol").length&&
(t=t+" ("+b.getAttribute("geneSymbol")+")");k.append("svg:text").attr("dx",function(){var c=a.xScale(b.getAttribute("start"));return c=c<$(window).width()/2?a.xScale(b.getAttribute("stop"))-a.xScale(b.getAttribute("start"))+5:-9*t.length}).attr("dy",10).attr("id","lblTxt").text(t)}else k.select("text#lblTxt").remove()};a.getSVGID=function(b){return a.getDisplayID(b.getAttribute("ID"))+" ("+b.getAttribute("geneSymbol")+")"};a.setupToolTipSVG=function(b,f){if("undefined"!==typeof b.getAttribute("extStart")&&
null!==b.getAttribute("extStart")){var c=parseInt(b.getAttribute("extStart"),10);var e=parseInt(b.getAttribute("extStop"),10)}else c=parseInt(b.getAttribute("start"),10),e=parseInt(b.getAttribute("stop"),10);var k=Math.floor((e-c)*f);10>k&&(k=10);c-=k;e+=k;k=toolTipSVG("div#ttSVG",450,c,e,99,a.getSVGID(b),"transcript");k.xMin=c;k.xMax=e;var g="none";"liverTotal"==a.trackClass?g="liverTotal":"heartTotal"==a.trackClass?g="heartTotal":"brainTotal"==a.trackClass?g="brainTotal":"mergedTotal"==a.trackClass?
g="mergedTotal":200>parseInt(b.getAttribute("stop"),10)-parseInt(b.getAttribute("start"),10)?g="small":"protein_coding"==b.getAttribute("biotype")&&200<=parseInt(b.getAttribute("stop"),10)-parseInt(b.getAttribute("start"),10)?g="protein":"protein_coding"!=b.getAttribute("biotype")&&200<=parseInt(b.getAttribute("stop"),10)-parseInt(b.getAttribute("start"),10)&&(g="long");k.txType=g;k.selectedData=b;g=[];g[0]=b;"undefined"!==typeof b.parent&&(g[0]=b.parent);k.addTrack(a.trackClass,2,"DrawTrx",g);for(g=
0;g<a.ttTrackList.length;g++)if(a.trackClass!==a.ttTrackList[g]){var q=a.gsvg.getTrackData(a.ttTrackList[g]),m=[];if("undefined"!==typeof q&&0<q.length){for(var r=0,h=0;h<q.length;h++)if(c<=parseInt(q[h].getAttribute("start"),10)&&parseInt(q[h].getAttribute("start"),10)<=e||c<=parseInt(q[h].getAttribute("stop"),10)&&parseInt(q[h].getAttribute("stop"),10)<=e||parseInt(q[h].getAttribute("start"),10)<=c&&parseInt(q[h].getAttribute("stop"),10)>=c)m[r]=q[h],r++;0<m.length&&k.addTrack(a.ttTrackList[g],
3,"DrawTrx",m)}}};a.draw=function(b){a.data=b;a.trackYMax=0;a.yMaxArr=[];a.yArr=[];a.yArr[0]=[];for(var c=0;c<a.gsvg.width;c++)a.yMaxArr[c]=0,a.yArr[0][c]=0;a.svg.selectAll(".gene").remove();c=a.drawAs;var d=a.xScale.domain()[0];if(a.xScale.domain()[1]-d<a.trxCutoff||$("#forceTrxCBX"+a.gsvg.levelNumber).is(":checked"))a.drawAs="Trx";d="Genes";"Trx"==a.drawAs&&(d="Transcripts");var e="Protein Coding",k=" / PolyA+";-1<a.trackClass.indexOf("noncoding")?(e="Long Non-Coding",k=" / Non-PolyA+"):-1<a.trackClass.indexOf("smallnc")?
(e="Brain",-1<a.trackClass.indexOf("liver")?e="Liver":-1<a.trackClass.indexOf("heart")&&(e="Heart"),e+=" Small RNA",k=""):"liverTotal"==a.trackClass?(e="Liver RNA-Seq Reconstruction ",k="Total RNA"):"heartTotal"==a.trackClass?(e="Heart RNA-Seq Reconstruction ",k="Total RNA"):"brainTotal"==a.trackClass?(e="Whole Brain RNA-Seq Reconstruction ",k="Total RNA"):"mergedTotal"==a.trackClass&&(e="Merged (Brain,Heart,Liver) Reconstructed",k="Total RNA");e=-1<a.trackClass.indexOf("ensembl")?"Ensembl "+e+" "+
d:"brainTotal"!=a.trackClass&&"liverTotal"!=a.trackClass&&"heartTotal"!=a.trackClass&&"mergedTotal"!=a.trackClass?"Reconstruction "+e+k+" "+d:e+k+" "+d;a.updateLabel(e);a.redrawLegend();d=b;if("Trx"===a.drawAs&&-1===a.trackClass.indexOf("smallnc"))for(d=[],k=e=0;k<b.length;k++)if("undefined"!==typeof b[k])for(var g=getAllChildrenByName(getFirstChildByName(b[k],"TranscriptList"),"Transcript"),q=0;q<g.length;q++)d[e]=g[q],d[e].parent=b[k],e++;0<d.length&&("Gene"===a.drawAs||-1<a.trackClass.indexOf("smallnc")?
(a.drawnAs="Gene",a.svg.selectAll(".trx0").each(function(){d3.select(this).remove()}),b=a.svg.selectAll(".gene").data(d,key).attr("transform",function(b,c){return"translate("+a.xScale(b.getAttribute("start"))+","+a.calcY(parseInt(b.getAttribute("start"),10),parseInt(b.getAttribute("stop"),10),c)+")"}),b.enter().append("g").attr("class","gene").attr("transform",function(b,c){return"translate("+a.xScale(b.getAttribute("start"))+","+a.calcY(parseInt(b.getAttribute("start"),10),parseInt(b.getAttribute("stop"),
10),c)+")"}).merge(b).append("rect").attr("height",10).attr("rx",1).attr("ry",1).attr("width",function(b){return a.xScale(b.getAttribute("stop"))-a.xScale(b.getAttribute("start"))}).attr("title",function(a){return a.getAttribute("ID")}).attr("stroke",a.colorStroke).attr("stroke-width","1").attr("id",function(a){return a.getAttribute("ID")}).style("fill",a.color).style("cursor","pointer").on("click",function(b){setTimeout(function(){a.setupDetailedView(b);d3.select(this).attr("class","selected").style("fill",
"green")}.bind(this),10)}).on("dblclick",a.zoomToFeature).on("mouseover",function(b){0===a.gsvg.isToolTip&&(overSelectable=1,$("#mouseHelp").html("<B>Click</B> to see additional details. <B>Double Click</B> to zoom in on this feature."),d3.select(this).style("fill","green"),tt.transition().duration(200).style("opacity",1),tt.html(a.createToolTip(b)).style("left",function(){return a.positionTTLeft(d3.event.pageX)}).style("top",function(){return a.positionTTTop(d3.event.pageY)}),b&&(a.triggerTableFilter(b),
-1===a.trackClass.indexOf("smallnc")?"Trx"===a.drawAs?a.setupToolTipSVG(b.parent,.05):a.setupToolTipSVG(b,.05):a.setupToolTipSVG(b,.05),tt.style("top",function(){return a.positionTTTop(d3.event.pageY)})))}).on("mouseout",function(b){$("#mouseHelp").html("Navigation Hints: Hold mouse over areas of the image for available actions.");"selected"!==d3.select(this).attr("class")&&d3.select(this).style("fill",a.color);tt.transition().delay(500).duration(200).style("opacity",0);a.clearTableFilter(b)}),b.exit().remove(),
d3.select("#Level"+a.gsvg.levelNumber+a.trackClass).selectAll("g.gene").each(function(b){if(b){var c=d3.select(this);if("-1"==b.getAttribute("strand")||"1"==b.getAttribute("strand")){var d=">";"-1"==b.getAttribute("strand")&&(d="<");var f=d,g=c.select("rect").attr("width");if(8.5>g)f="";else for(g-=8.5,f=d;8.7<g;)f+=d,g-=8.5;c.append("svg:text").attr("dx","1").attr("dy","10").attr("id","strandTxt").style("pointer-events","none").text(f)}if(2===a.density){var k=b.getAttribute("ID");b.getAttribute("geneSymbol")&&
0<b.getAttribute("geneSymbol").length&&(k=k+" ("+b.getAttribute("geneSymbol")+")");c.append("svg:text").attr("dx",function(){var c=a.xScale(b.getAttribute("start"));return c=c<$(window).width()/2?a.xScale(b.getAttribute("stop"))-a.xScale(b.getAttribute("start"))+5:-9*k.length}).attr("dy",10).attr("id","lblTxt").text(k)}else c.select("text#lblTxt").remove()}}),1==a.density?a.svg.attr("height",30):2==a.density?a.svg.attr("height",15*(d3.select("#Level"+a.gsvg.levelNumber+a.trackClass).selectAll("g.gene").size()+
1)):3==a.density&&a.svg.attr("height",15*(a.trackYMax+1))):"Trx"==a.drawAs&&(a.drawnAs="Trx",a.svg.selectAll(".gene").each(function(){d3.select(this).remove()}),a.svg.selectAll(".trx"+a.gsvg.levelNumber).remove(),b=a.svg.selectAll(".trx"+a.gsvg.levelNumber).data(d,key).attr("transform",function(b,c){return"translate("+a.xScale(b.getAttribute("start"))+","+a.calcY(parseInt(b.getAttribute("start"),10),parseInt(b.getAttribute("stop"),10),c)+")"}),b.enter().append("g").attr("class",function(b){b=new String(b.parent.getAttribute("ID"));
return"trx"+a.gsvg.levelNumber+" gene"+b.replace(".","_")}).attr("transform",function(b,c){return"translate(0,"+a.calcY(parseInt(b.getAttribute("start"),10),parseInt(b.getAttribute("stop"),10),c)+")"}).attr("id",function(b){var c="";1==a.gsvg.levelNumber&&(c="tx");99==a.gsvg.levelNumber&&(c="ttTx");return c+b.getAttribute("ID")+a.gsvg.levelNumber}).style("cursor","pointer").on("click",function(b){setTimeout(function(){if(0==a.gsvg.levelNumber){var c=(new String(b.parent.getAttribute("ID"))).replace(".",
"_");a.svg.selectAll("g.trx"+a.gsvg.levelNumber+".selected").selectAll("line").style("stroke",a.color);a.svg.selectAll("g.trx"+a.gsvg.levelNumber+".selected").selectAll("rect").style("fill",a.color);a.svg.selectAll("g.trx"+a.gsvg.levelNumber+".selected").selectAll("text").style("opacity","0.6").style("fill",a.color);a.svg.selectAll("g.trx"+a.gsvg.levelNumber+".selected").each(function(){var a=new String($(this).attr("class"));a=a.replace(" selected","");$(this).attr("class",a)});a.svg.selectAll("g.gene"+
c).each(function(){var a=$(this).attr("class")+" selected";$(this).attr("class",a)});a.svg.selectAll("g.gene"+c).selectAll("line").style("stroke","green");a.svg.selectAll("g.gene"+c).selectAll("rect").style("fill","green");a.svg.selectAll("g.gene"+c).selectAll("text").style("opacity","0.3").style("fill","green");a.setupDetailedView(b.parent)}},10)}).on("dblclick",a.zoomToFeature).on("mouseover",function(b){if(0===a.gsvg.isToolTip){if(0===a.gsvg.levelNumber&&"undefined"!==typeof b.parent){var c=(new String(b.parent.getAttribute("ID"))).replace(".",
"_");a.svg.selectAll("g.gene"+c).selectAll("line").style("stroke","green");a.svg.selectAll("g.gene"+c).selectAll("rect").style("fill","green");a.svg.selectAll("g.gene"+c).selectAll("text").style("opacity","0.3").style("fill","green")}else d3.select(this).selectAll("line").style("stroke","green"),d3.select(this).selectAll("rect").style("fill","green"),d3.select(this).selectAll("text").style("opacity","0.3").style("fill","green");tt.transition().duration(200).style("opacity",1);tt.html(a.createToolTip(b)).style("left",
function(){return a.positionTTLeft(d3.event.pageX)}).style("top",function(){return a.positionTTTop(d3.event.pageY)});a.triggerTableFilter(b);if("undefined"!==typeof b){if(-1===a.trackClass.indexOf("smallnc"))a.setupToolTipSVG(b,.05);else{c=toolTipSVG("div#ttSVG",450,parseInt(b.getAttribute("start"),10)-10,parseInt(b.getAttribute("stop"),10)+10,99,a.getDisplayID(b.getAttribute("ID")),"");c.xMin=parseInt(b.getAttribute("start"),10)-20;c.xMax=parseInt(b.getAttribute("stop"),10)+20;var d=[];d[0]=b;c.addTrack(a.trackClass,
2,"",d)}tt.style("top",function(){return a.positionTTTop(d3.event.pageY)})}}}).on("mouseout",function(b){if(-1==(new String(d3.select(this).attr("class"))).indexOf("selected"))if(0==a.gsvg.levelNumber){var c=(new String(b.parent.getAttribute("ID"))).replace(".","_");a.svg.selectAll("g.gene"+c).selectAll("line").style("stroke",a.color);a.svg.selectAll("g.gene"+c).selectAll("rect").style("fill",a.color);a.svg.selectAll("g.gene"+c).selectAll("text").style("opacity","0.6").style("fill",a.color)}else d3.select(this).selectAll("line").style("stroke",
a.color),d3.select(this).selectAll("rect").style("fill",a.color),d3.select(this).selectAll("text").style("opacity","0.6").style("fill",a.color);tt.transition().delay(500).duration(200).style("opacity",0);a.clearTableFilter(b)}).merge(b).each(a.drawTrx),b.exit().remove(),b,1==a.density?a.svg.attr("height",30):2==a.density?a.svg.attr("height",15*(d3.select("#Level"+a.gsvg.levelNumber+a.trackClass).selectAll("g.trx"+a.gsvg.levelNumber).size()+1)):3==a.density&&a.svg.attr("height",15*(a.trackYMax+1))));
""!=selectGene&&a.setSelected(selectGene);a.redrawSelectedArea();a.drawAs=c};a.redrawLegend=function(){var b=[],f=0;"Trx"===a.drawAs&&("braincoding"===a.trackClass?"Rn"===organism&&(b[f]={color:"#7EB5D6",label:"All"},f++,b[f]={color:"#5E95FF",label:"BN-Lx"},f++,b[f]={color:"#BE95B6",label:"SHR"},f++):"brainnoncoding"===a.trackClass?"Rn"===organism&&(b[f]={color:"#CECFCE",label:"All"},f++,b[f]={color:"#3E75FF",label:"BN-Lx"},f++,b[f]={color:"#FE7596",label:"SHR"},f++):"liverTotal"===a.trackClass?(b[f]=
{color:"#bbbedd",label:"All"},f++,b[f]={color:"#9b9eFF",label:"BN-Lx"},f++,b[f]={color:"#Fb9eBd",label:"SHR"},f++):"heartTotal"===a.trackClass?(b[f]={color:"#DC7252",label:"All"},f++,b[f]={color:"#BC5292",label:"BN-Lx"},f++,b[f]={color:"#FF5232",label:"SHR"},f++):"mergedTotal"!==a.trackClass&&"brainTotal"===a.trackClass&&(b[f]={color:"#7EB5D6",label:"All"},f++,b[f]={color:"#5E95FF",label:"BN-Lx"},f++,b[f]={color:"#BE95B6",label:"SHR"},f++));"brainsmallnc"===a.trackClass?(b[f]={color:"#3E7596",label:"All"},
f++,b[f]={color:"#1E55D6",label:"BN-Lx"},f++,b[f]={color:"#7E5576",label:"SHR"}):"heartsmallnc"===a.trackClass?(b[f]={color:"#9C3212",label:"All"},f++,b[f]={color:"#7C1252",label:"BN-Lx"},f++,b[f]={color:"#DC1200",label:"SHR"}):"liversmallnc"===a.trackClass&&(b[f]={color:"#7b7e9d",label:"All"},f++,b[f]={color:"#5b5eDd",label:"BN-Lx"},f++,b[f]={color:"#bb5e7d",label:"SHR"});a.drawLegend(b)};a.triggerTableFilter=function(b){var c=jQuery.Event("keyup");c.which=32;var d="";"undefined"!==typeof b.getAttribute&&
"undefined"!==typeof b.getAttribute("ID")&&(d=a.getDisplayID(b.getAttribute("ID")));-1==a.trackClass.indexOf("smallnc")?$("#tblGenes"+a.trackClass+"_filter input").val(d).trigger(c):$("#tblsmGenes_filter input").val(d).trigger(c)};a.clearTableFilter=function(b){b=jQuery.Event("keyup");b.which=32;"smallnc"!=a.trackClass?$("#tblGenes"+a.trackClass+"_filter input").val("").trigger(b):$("#tblsmGenes_filter input").val("").trigger(b)};a.updateSettingsFromUI=function(){0<$("#"+a.trackClass+"Dense"+a.level+
"Select").length&&(a.density=$("#"+a.trackClass+"Dense"+a.level+"Select").val(),"string"===typeof a.density&&(a.density=parseInt(a.density)));0<$("#"+a.trackClass+"Version"+a.level+"Select").length&&(a.reqDataVer=$("#"+a.trackClass+"Version"+a.level+"Select").val())};a.savePrevious=function(){a.prevSetting={};a.prevSetting.density=a.density;a.prevSetting.dataVer=a.dataVer};a.revertPrevious=function(){a.density=a.prevSetting.density;a.dataVer=a.prevSetting.dataVer};a.updateSettings=function(a){};a.generateTrackSettingString=
function(){return a.trackClass+","+a.density+","+a.dataVer+";"};a.redrawLegend();a.draw(h);return a}
...
1].getAttribute("stop")),C=a.xScale(exList[k].getAttribute("start"));if("1"==b.getAttribute("strand")||"-1"==b.getAttribute("strand")||"-"==b.getAttribute("strand")||"+"==b.getAttribute("strand")){var D=">";"-1"==b.getAttribute("strand")&&(D="<");var y=D,B=C-u,z=0;if(7>B)y="";else for(B-=7;8<B;)0==z?(y+=" ",z=1):(y+=D,z=0),B-=7;d3.select("#Level"+a.gsvg.levelNumber+a.trackClass).select("g#"+e+b.getAttribute("ID")+" #IntTxt"+exList[k-1].getAttribute("ID")+"_"+exList[k].getAttribute("ID")).attr("dx",
u+1).text(y)}d3.select("#Level"+a.gsvg.levelNumber+a.trackClass).select("g#"+e+b.getAttribute("ID")+" line#Int"+exList[k-1].getAttribute("ID")+"_"+exList[k].getAttribute("ID")).attr("x1",u).attr("x2",C)}}}),1==a.density?a.svg.attr("height",30):2==a.density?a.svg.attr("height",15*(d3.select("#Level"+a.gsvg.levelNumber+a.trackClass).selectAll("g.trx"+a.gsvg.levelNumber).size()+1)):3==a.density&&a.svg.attr("height",15*(a.trackYMax+1));a.redrawSelectedArea()};a.updateData=function(b){a.xScale.domain();
...
k="";1==a.gsvg.levelNumber&&(k="tx");k=a.svg.select("#"+k+b.getAttribute("ID"));exList=getAllChildrenByName(getFirstChildByName(b,"exonList"),"exon");for(var g=0;g<exList.length;g++){var q=parseInt(exList[g].getAttribute("start"),10),m=parseInt(exList[g].getAttribute("stop"),10);if(q<c&&c<m||m>e&&e>q){var h=0,l=0,p=0,v=0;q<c?(h=a.xScale(q),l=a.xScale(c)-a.xScale(q),p=a.xScale(c),v=a.xScale(m)-a.xScale(c)):m>e&&(p=a.xScale(q),v=a.xScale(e)-a.xScale(q),h=a.xScale(e),l=a.xScale(m)-a.xScale(e));k.append("rect").attr("x",
h).attr("y",2.5).attr("height",5).attr("width",l).attr("title",function(a){return exList[g].getAttribute("ID")}).attr("id",function(a){return"ExNC"+exList[g].getAttribute("ID")}).style("fill",a.color).style("cursor","pointer");k.append("rect").attr("x",p).attr("height",10).attr("width",v).attr("title",function(a){return exList[g].getAttribute("ID")}).attr("id",function(a){return"Ex"+exList[g].getAttribute("ID")}).style("fill",a.color).style("cursor","pointer")}else{h=10;l=0;if(q<c&&m<c||m>e&&q>e)h=
...
","+a.include+";"};a.generateSettingsDiv=function(b){var c=trackInfo[a.trackClass];a.savePrevious();d3.select(b).select("table").select("tbody").html("");if(0<c.Controls.length&&"null"!=c.Controls){var f=(new String(c.Controls)).split(",");b=d3.select(b).select("table").select("tbody");b.append("tr").append("td").style("font-weight","bold").html("Track Settings: "+c.Name);for(c=0;c<f.length;c++)if("undefined"!==typeof f[c]&&""!=f[c]){var e=f[c].split(";"),g=b.append("tr").append("td"),h=e[0].substr(5);
g.append("text").text(h+": ");3<e.length&&0==e[3].indexOf("Default=")&&e[3].substr(8);if(0==e[1].toLowerCase().indexOf("select")){var m=e[1].split(":");e=e[2].split("}");var l=h="";2<m.length&&(h=m[2]);3<m.length&&(l=m[3]);g=g.append("select").attr("id",a.trackClass+h+a.level+l).attr("name",m[1]);for(m=0;m<e.length;m++){var p=e[m].substr(1).split(":");if(2==p.length){var A=g.append("option").attr("value",p[1]).text(p[0]);("Dense"==h&&p[1]==a.density||""==h&&p[1]==a.include)&&A.attr("selected","selected")}}d3.select("#"+
a.trackClass+h+a.level+l).on("change",function(){a.updateSettingsFromUI();a.updateData()})}else console.log("Undefined track settings:  "+f[c])}f=b.append("tr").append("td");f.append("input").attr("type","button").attr("value","Remove Track").style("float","left").style("margin-left","5px").on("click",function(){$("#trackSettingDialog").fadeOut("fast");a.gsvg.removeTrack(a.trackClass);var b=svgList[a.gsvg.levelNumber].currentView.ViewID,c=viewMenu[a.gsvg.levelNumber].findTrackByClass(a.trackClass,
...
"heartTotal"==b.gsvg.txType?c=d3.rgb("#DC7252"):"mergedTotal"==b.gsvg.txType&&(c=d3.rgb("#9F4F92"));return c};b.drawTrx=function(a,c){var f=parseInt(a.getAttribute("start"),10),d=parseInt(a.getAttribute("stop"),10);"undefined"!==typeof a.getAttribute("cdsStart")&&"undefined"!==typeof a.getAttribute("cdsStop")&&(f=parseInt(a.getAttribute("cdsStart"),10),d=parseInt(a.getAttribute("cdsStop"),10));var e=d3.select("#Level"+b.gsvg.levelNumber+b.trackClass+" #tx"+a.getAttribute("ID"));exList=getAllChildrenByName(getFirstChildByName(a,
"exonList"),"exon");for(var k=0;k<exList.length;k++){var g=parseInt(exList[k].getAttribute("start"),10),h=parseInt(exList[k].getAttribute("stop"),10);if(g<f&&f<h||h>d&&d>g){var m=0,l=0,p=0,A=0;g<f?(m=b.xScale(exList[k].getAttribute("start")),l=b.xScale(f)-b.xScale(exList[k].getAttribute("start")),p=b.xScale(f),A=b.xScale(exList[k].getAttribute("stop"))-b.xScale(f)):h>d&&(p=b.xScale(exList[k].getAttribute("start")),A=b.xScale(d)-b.xScale(exList[k].getAttribute("start")),m=b.xScale(d),l=b.xScale(exList[k].getAttribute("stop"))-
b.xScale(d));e.append("rect").attr("x",m).attr("y",2.5).attr("height",5).attr("width",l).attr("title",function(a){return exList[k].getAttribute("ID")}).attr("id",function(a){return"ExNC"+exList[k].getAttribute("ID")}).style("fill",b.color).style("cursor","pointer");e.append("rect").attr("x",p).attr("height",10).attr("width",A).attr("title",function(a){return exList[k].getAttribute("ID")}).attr("id",function(a){return"Ex"+exList[k].getAttribute("ID")}).style("fill",b.color).style("cursor","pointer")}else{m=
10;l=0;if(g<f&&h<f||h>d&&g>d)m=5,l=2.5;e.append("rect").attr("x",function(a){return b.xScale(exList[k].getAttribute("start"))}).attr("y",l).attr("height",m).attr("width",function(a){return b.xScale(exList[k].getAttribute("stop"))-b.xScale(exList[k].getAttribute("start"))}).attr("title",function(a){return exList[k].getAttribute("ID")}).attr("id",function(a){return"Ex"+exList[k].getAttribute("ID")}).style("fill",b.color).style("cursor","pointer")}if(0<k){e.append("line").attr("x1",function(a){return b.xScale(exList[k-
1].getAttribute("stop"))}).attr("x2",function(a){return b.xScale(exList[k].getAttribute("start"))}).attr("y1",5).attr("y2",5).attr("id",function(a){return"Int"+exList[k-1].getAttribute("ID")+"_"+exList[k].getAttribute("ID")}).attr("stroke",b.color).attr("stroke-width","2");g=">";"-1"==a.getAttribute("strand")&&(g="<");h=g;m=b.xScale(exList[k-1].getAttribute("stop"));l=b.xScale(exList[k].getAttribute("start"))-m;p=0;if(7>l)h="";else for(l-=7;8<l;)0==p?(h+=" ",p=1):(h+=g,p=0),l-=7;e.append("svg:text").attr("id",
function(a){return"IntTxt"+exList[k-1].getAttribute("ID")+"_"+exList[k].getAttribute("ID")}).attr("dx",m+1).attr("dy","11").style("pointer-events","none").style("opacity","0.5").style("fill",b.color).style("font-size","16px").text(h)}}};b.redraw=function(){d3.select("#Level"+b.gsvg.levelNumber+b.trackClass).selectAll("g.trx"+b.gsvg.levelNumber).each(function(a,c){var f=parseInt(a.getAttribute("start"),10),d=parseInt(a.getAttribute("stop"),10);"undefined"!==typeof a.getAttribute("cdsStart")&&"undefined"!==
typeof a.getAttribute("cdsStop")&&(f=parseInt(a.getAttribute("cdsStart"),10),d=parseInt(a.getAttribute("cdsStop"),10));exList=getAllChildrenByName(getFirstChildByName(a,"exonList"),"exon");for(var e=0;e<exList.length;e++){var k=parseInt(exList[e].getAttribute("start"),10),g=parseInt(exList[e].getAttribute("stop"),10);if(k<f&&f<g||g>d&&d>k){var h=k,m=f;g>d?(h=d,m=g,g=d):k=f;d3.select("#Level"+b.gsvg.levelNumber+b.trackClass+" g#tx"+a.getAttribute("ID")+" rect#ExNC"+exList[e].getAttribute("ID")).attr("x",
function(a){return b.xScale(h)}).attr("width",function(a){return b.xScale(m)-b.xScale(h)})}d3.select("#Level"+b.gsvg.levelNumber+b.trackClass+" g#tx"+a.getAttribute("ID")+" rect#Ex"+exList[e].getAttribute("ID")).attr("x",function(a){return b.xScale(k)}).attr("width",function(a){return b.xScale(g)-b.xScale(k)});if(0<e){var l=">";"-1"==a.getAttribute("strand")&&(l="<");var p=l,A=b.xScale(exList[e-1].getAttribute("stop")),v=b.xScale(exList[e].getAttribute("start")),t=v-A,u=0;if(7>t)p="";else for(t-=
7;8<t;)0==u?(p+=" ",u=1):(p+=l,u=0),t-=7;d3.select("#Level"+b.gsvg.levelNumber+b.trackClass+" g#tx"+a.getAttribute("ID")+" line#Int"+exList[e-1].getAttribute("ID")+"_"+exList[e].getAttribute("ID")).attr("x1",A).attr("x2",v);d3.select("#Level"+b.gsvg.levelNumber+b.trackClass+" g#tx"+a.getAttribute("ID")+" #IntTxt"+exList[e-1].getAttribute("ID")+"_"+exList[e].getAttribute("ID")).attr("dx",A+1).text(p)}}});b.redrawSelectedArea()};b.update=function(){var a=getAllChildrenByName(getFirstChildByName(b.gsvg.selectedData,
"TranscriptList"),"Transcript"),c=parseInt(b.gsvg.selectedData.getAttribute("start"),10),f=parseInt(b.gsvg.selectedData.getAttribute("stop"),10);"undefined"!==typeof b.gsvg.selectedData.getAttribute("extStart")&&"undefined"!==typeof b.gsvg.selectedData.getAttribute("extStop")&&(c=parseInt(b.gsvg.selectedData.getAttribute("extStart"),10),f=parseInt(b.gsvg.selectedData.getAttribute("extStop"),10));b.txMin=c;b.txMax=f;b.svg.attr("height",15*(1+a.length));d3.select("#Level"+b.gsvg.levelNumber+b.trackClass).selectAll(".trx"+
...
c,a.loadedDataMax=e,n=k.documentElement.getElementsByTagName("Count"),a.draw(n),a.updateControl=0)})}};a.updateLabel(e);a.redrawLegend();a.redraw();return a}
function CountTrack(e,h,l,p){var b=Track(e,h,l,"Generic Counts");b.loadedDataMin=b.xScale.domain()[0];b.loadedDataMax=b.xScale.domain()[1];b.dataFileName=b.trackClass;b.scaleMin=1;b.scaleMax=5E3;b.graphColorText="steelblue";b.colorScale=d3.scaleLinear().domain([b.scaleMin,b.scaleMax]).range(["#EEEEEE","#000000"]);b.ttSVG=1;b.ttTrackList=[];-1<l.indexOf("illuminaSmall")?(b.ttTrackList.push("ensemblsmallnc"),b.ttTrackList.push("brainsmallnc"),b.ttTrackList.push("liversmallnc"),b.ttTrackList.push("heartsmallnc")):
(b.ttTrackList.push("ensemblcoding"),b.ttTrackList.push("braincoding"),b.ttTrackList.push("liverTotal"),b.ttTrackList.push("heartTotal"),b.ttTrackList.push("mergedTotal"),b.ttTrackList.push("refSeq"),b.ttTrackList.push("ensemblnoncoding"),b.ttTrackList.push("brainnoncoding"),b.ttTrackList.push("probe"),b.ttTrackList.push("polyASite"),b.ttTrackList.push("spliceJnct"),b.ttTrackList.push("liverspliceJnct"),b.ttTrackList.push("heartspliceJnct"));b.ttTrackList.push("repeatMask");b.calculateBin=function(a){a=
new String(Math.floor(a/b.gsvg.width));a=a.substr(0,1)*Math.pow(10,a.length-1);a=Math.floor(a/2);5>a&&(a=0);return a};b.data=h;b.density=p;b.prevDensity=p;b.displayBreakDown=null;e=b.gsvg.xScale.domain()[0];l=b.gsvg.xScale.domain()[1];b.bin=b.calculateBin(l-e);b.fullDataTimeOutHandle=0;b.color=function(a){var c="#FFFFFF";a.getAttribute("count")>=b.scaleMin&&(c=d3.rgb(b.colorScale(a.getAttribute("count"))));return c};b.redraw=function(){var a=b.gsvg.xScale.domain()[0],c=b.gsvg.xScale.domain()[1];b.xScale(a+
b.bin);b.xScale(a);b.prevMinCoord=a;b.prevMaxCoord=c;a=b.xScale.domain()[0];c=b.xScale.domain()[1];for(var f=[],d=0,e=0,k=0;k<b.data.length;k++)if("undefined"!==typeof b.data[k]){var g=parseInt(b.data[k].getAttribute("start"),10),h=parseInt(b.data[k].getAttribute("stop"),10),m=parseInt(b.data[k].getAttribute("count"),10);if(1!=b.density||1==b.density&&g!=h)if(k+1<b.data.length){if(h=parseInt(b.data[k+1].getAttribute("start"),10),g>=a&&g<=c||h>=a&&h<=c)f[d]=b.data[k],m>e&&(e=m),d++}else g>=a&&g<=c&&
(f[d]=b.data[k],m>e&&(e=m),d++)}1==b.density?(b.density!=b.prevDensity?(b.redrawLegend(),c=b.gsvg.xScale.domain()[1],b.prevDensity=b.density,b.svg.selectAll(".area").remove(),b.svg.selectAll("g.y").remove(),b.svg.selectAll(".grid").remove(),b.svg.selectAll(".leftLbl").remove(),a=b.svg.selectAll("."+b.trackClass).data(f,keyStart),a.enter().append("rect").attr("x",function(a){return b.xScale(a.getAttribute("start"))}).attr("y",15).attr("class",b.trackClass).attr("height",10).attr("width",function(a,
...
0)}),a.exit().remove()):b.svg.selectAll("."+b.trackClass).attr("x",function(a){return b.xScale(a.getAttribute("start"))}).attr("width",function(a,c){return b.xScale(a.getAttribute("stop"))-b.xScale(a.getAttribute("start"))}).attr("fill",b.color),b.svg.attr("height",30)):2==b.density&&(b.svg.selectAll("."+b.trackClass).remove(),b.svg.select(".y.axis").remove(),b.svg.select("g.grid").remove(),b.svg.selectAll(".leftLbl").remove(),b.yScale.domain([0,e]),b.svg.select(".area").remove(),b.area=d3.area().x(function(a){return b.xScale(a.getAttribute("start"))}).y0(140).y1(function(a){return b.yScale(a.getAttribute("count"))}),
...
": ");h=f[1].split(":");f=f[2].split("}");var m=c.trackClass+"Dense"+c.level+"Select";"colorSelect"==h[1]&&(m=c.trackClass+c.level+"colorSelect");g=g.append("select").attr("id",m).attr("name",h[1]);for(h=0;h<f.length;h++){var l=f[h].substr(1).split(":");if(2==l.length){var p=g.append("option").attr("value",l[1]).text(l[0]);(-1<m.indexOf("Dense")&&l[1]==c.density||-1<m.indexOf("colorSelect")&&l[1]==c.colorBy)&&p.attr("selected","selected")}}d3.select("select#"+m).on("change",function(){"Score"==$(this).val()?
$("div."+c.trackClass+"Scale"+c.level).show():"Color"==$(this).val()&&$("div."+c.trackClass+"Scale"+c.level).hide();c.updateSettingsFromUI();c.draw(c.data)})}else 0==f[1].toLowerCase().indexOf("txt")&&(g=0==$("#colorTrack"+c.level).size()?g.append("div").attr("class",c.trackClass+"Scale"+c.level).style("display","none"):d3.select("#"+c.trackClass+"Scale"+c.level),g.append("text").text(h+": "),h=f[1].split(":"),f=f[2].split("}"),f="Data",m="text",l=c.minValue,p=c.maxValue,"color"==h[1]&&(m=f="Color",
l=c.minColor,p=c.maxColor),g.append("input").attr("type",m).attr("id",c.trackClass+"min"+f+c.level).attr("class",h[1]).style("margin-left","5px").attr("value",l),g.append("text").text(" - "),g.append("input").attr("type",m).attr("id",c.trackClass+"max"+f+c.level).attr("class",h[1]).style("margin-left","5px").attr("value",p),"Color"==f&&(testIE||testSafari)?($("#"+c.trackClass+"min"+f+c.level).spectrum({change:function(a){c.updateSettingsFromUI();c.draw(c.data)}}),$("#"+c.trackClass+"max"+f+c.level).spectrum({change:function(a){c.updateSettingsFromUI();
...
function(a){return c.xScale(d[e].getAttribute("stop"))-c.xScale(d[e].getAttribute("start"))});if(0<e){f=">";"-1"==a.getAttribute("strand")&&(f="<");var h=f,l=c.xScale(d[e-1].getAttribute("stop"))-c.xScale(a.getAttribute("start")),n=c.xScale(d[e].getAttribute("start"))-c.xScale(a.getAttribute("start")),p=n-l,v=0;if(7>p)h="";else for(p-=7;8<p;)0==v?(h+=" ",v=1):(h+=f,v=0),p-=7;f=d[e-1].getAttribute("ID")+"_"+d[e].getAttribute("ID");null==d[e].getAttribute("ID")&&(f=a.getAttribute("ID")+"_"+(e-1)+"_"+
