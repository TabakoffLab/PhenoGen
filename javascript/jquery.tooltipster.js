...
Modified 4/9/13- Spencer Mahaffey for PhenoGen

The margins on the side of the page throws off the positioning.  I adjusted the left and right aligned calculated positions by 1/2 the width of the window over 1000px.
*/
		...
		positionTooltip: function(options) {
			...
			if (($this.data('tooltipster') !== undefined) && ($this.data('tooltipster') !== '')) {
				...
				if(object.options.position == 'top-left') {
					...
					if(windowWidth>1000){
							myLeft=myLeft-((windowWidth-1000)/2);
					}
					myTop = (offsetTop - tooltipHeight) - offsetY - 12;
					dontGoOffScreenX();
				...
				if(object.options.position == 'top-right') {
					//alert("offsetLeft:"+offsetLeft+"offsetX"+offsetX+"w:"+tooltipWidth);
					myLeft = (offsetLeft +  offsetX) - tooltipWidth;
					if(windowWidth>1000){
							myLeft=myLeft-((windowWidth-1000)/2);
					}
					myTop = (offsetTop - tooltipHeight) - offsetY - 12;
